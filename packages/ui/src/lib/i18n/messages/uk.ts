...
export const dict: Record<I18nKey, string> = {
  ...
  "opencodeCompatibility.outdatedLocal": "Встановлено OpenCode {version}. Ця версія OpenChamber потребує OpenCode {minimum} або новішого.",
  "opencodeCompatibility.outdatedExternal": "Підключений сервер використовує OpenCode {version}. Оновіть його до OpenCode {minimum} або новішого, а потім підключіться знову.",
  "opencodeCompatibility.update": "Оновити OpenCode",
  "opencodeCompatibility.local": "Встановлено OpenCode {version}. Ця версія OpenChamber потребує OpenCode v2.",
  "opencodeCompatibility.external": "Підключений сервер використовує OpenCode {version}. Встановіть на ньому OpenCode v2, а потім підключіться знову.",
  "opencodeCompatibility.installDescription": "OpenChamber встановить v2 через офіційний інсталятор, а потім перезапустить OpenCode.",
  "opencodeCompatibility.install": "Оновити до OpenCode v2",
  "opencodeCompatibility.reconnect": "Перевірити знову",
  "opencodeCompatibility.guide": "Інструкція зі встановлення",
  "opencodeCompatibility.installing": "Встановлення OpenCode v2…",
  "opencodeCompatibility.reconnecting": "Повторне підключення…",
  "opencodeCompatibility.failed": "Не вдалося завершити операцію. Спробуйте ще раз або скористайтеся інструкцією зі встановлення й підключіться знову.",
  ...
  'smallModel.toast.unavailable.title': 'Small Model недоступна',
  'smallModel.toast.unavailable.description': 'Оберіть іншу модель у Налаштування → Сесії → Small Model і спробуйте ще раз.',
  ...
  'chat.message.context.showQuoteSource': 'Показати в оригінальному повідомленні',
  ...
  "sessions.sidebar.header.viewMode.projects": "Згруповано",
  "sessions.sidebar.header.viewMode.timeline": "Хронологія",
  ...
  "sessions.sidebar.session.moveToWorktree.tooltip": 'Створює новий worktree з поточної гілки й переносить туди цю сесію та її підсесії. Незакомічені зміни лишаються у вихідному worktree.',
  ...
  "sessions.sidebar.session.rename.error": "Не вдалося перейменувати сесію. {detail}",
  "sessions.sidebar.session.action.upstreamErrorWithRef": "OpenCode відповів {status} {name} (ref {ref}). Пошукай цей ref у лозі OpenCode.",
  "sessions.sidebar.session.action.upstreamError": "OpenCode відповів {status}: {message}",
  ...
  "diffView.fileTree.showAsList": "Списком",
  "diffView.fileTree.showAsTree": "Деревом",
  "diffView.fileTree.collapseDirectoryAria": "Згорнути {path}",
  "diffView.fileTree.expandDirectoryAria": "Розгорнути {path}",
  "diffView.fileTree.resize": "Змінити ширину дерева файлів",
  ...
  "chat.goal.button.noSmallModel": "Для цілей потрібна Small Model. Увійдіть до провайдера моделей або оберіть її в Налаштування → Сесії.",
  "chat.goal.dialog.noSmallModel": "Цілям потрібна Small Model, щоб перевіряти прогрес. Увійдіть до провайдера моделей або оберіть її в Налаштування → Сесії.",
  ...
  "aboutDialog.appVersionLabel": "Версія застосунку {version}",
  ...
  "chat.changedFiles.actions.showMore": "Показати ще ({count})",
  "chat.changedFiles.actions.collapse": "Згорнути",
  ...
  "chat.textSelection.comment.save": "Зберегти коментар",
  ...
  "chat.toolPart.questionsAsked": 'Поставлено запитань: {count}',
  "chat.toolPart.filesCount": 'Файлів: {count}',
  "chat.toolPart.moreToolCalls": 'ще +{count}',
  ...
  "onboarding.localSetup.description": "Установіть OpenCode v2 CLI, щоб продовжити.",
  ...
  "onboarding.localSetup.intro": "Установіть OpenCode v2 CLI, щоб продовжити.",
  "onboarding.localSetup.docs.windows": "Інструкція зі встановлення",
  "onboarding.localSetup.docs.default": "Інструкція зі встановлення",
  ...
  "onboarding.localSetup.status.watching": "Очікування OpenCode v2",
  ...
  "projectConfigError.toast.title": "OpenCode не може завантажити конфігурацію цього проєкту",
  "projectConfigError.toast.unknownFile": "Конфігурація проєкту",
  "projectConfigError.toast.hint": "Виправте файл і повторіть спробу. Інші проєкти працюють як звичайно.",
  "projectConfigError.toast.retry": "Повторити",
  "projectConfigError.toast.retrying": "Повторюємо…",
  ...
  "startup.initRecovery.serverUnreachable": "OpenChamber не зміг зв’язатися із сервером. Перевірте, що сервер запущений, і повторіть спробу.",
  "startup.initRecovery.loadAgentsFailed": "Сервер працює, але OpenCode не зміг завантажити агентів. Повторіть спробу, коли причину буде усунено.",
  "startup.initRecovery.unexpected": "OpenChamber не зміг завершити запуск. Повторіть спробу, коли причину буде усунено.",
  ...
  "opencodeUpdate.toast.available.manualDescription": 'Доступна версія {version}. Оновіть OpenCode так само, як установлювали, і перезапустіть OpenChamber.',
  ...
  'chat.formDock.progress': '{current} з {total}',
  'chat.formDock.waiting': 'ще {count} в черзі',
  'chat.formDock.back': 'Назад',
  'chat.formDock.expandAria': 'Розгорнути запитання',
  'chat.formDock.collapseAria': 'Згорнути запитання',
  'chat.formDock.stepAria': 'Запитання {index}: {title}',
  'chat.formDock.linkInfo': 'Відкрийте посилання, потім продовжуйте.',
  'chat.permissionCard.title': 'Потрібен дозвіл',
  ...
  'chat.permissionCard.showDetails': "Показати подробиці",
  'chat.permissionDock.expandAria': 'Розгорнути запит дозволу',
  'chat.permissionDock.collapseAria': 'Згорнути запит дозволу',
  'chat.permissionDock.stepAria': 'Запит {index}: {tool}',
  'chat.permissionCard.allowOnce': 'Дозволити раз',
  'chat.permissionCard.alwaysAllow': 'Дозволяти завжди',
  'chat.permissionCard.alwaysAllowPatterns': 'Завжди: {patterns}',
  'chat.permissionCard.deny': 'Відхилити',
  'chat.permissionCard.replaceAll': 'Замінює всі входження',
