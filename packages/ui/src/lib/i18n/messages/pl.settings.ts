...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': 'Importuj motyw VS Code (Open VSX)',
  'settings.themeImport.catalogHint': 'Szukaj motywów VS Code w Open VSX. Motywy opublikowane tylko w Microsoft Marketplace mogą być niedostępne.',
  'settings.themeImport.search': 'Szukaj motywów',
  'settings.themeImport.catalogError': 'Nie udało się pobrać motywów z Open VSX. Wyszukaj ponownie.',
  'settings.themeImport.empty': 'Nie znaleziono motywów w Open VSX.',
  'settings.themeImport.back': 'Wróć do wyszukiwania',
  'settings.themeImport.chooseFile': 'Wybierz plik JSON',
  'settings.themeImport.importSelected': 'Importuj wybrane warianty',
  'settings.themeImport.installed': 'Zaimportowano',
  'settings.themeImport.partialError': 'Nie udało się zapisać niektórych motywów. Udane importy zachowano. Możesz ponowić import pozostałych wariantów.',
  'settings.themeImport.delete': 'Usuń zaimportowany motyw {name}',
  'settings.themeImport.deleteError': 'Nie udało się usunąć motywu. Został zachowany.',
  'settings.themeImport.action': 'Importuj motyw VS Code',
  'settings.themeImport.busy': 'Importowanie motywu…',
  'settings.themeImport.hint': 'Importuj motyw VS Code z pliku .json lub .jsonc wraz z kolorami składni i diff. Zostanie zapisany na połączonym serwerze OpenChamber.',
  'settings.themeImport.success': 'Zaimportowano {name}.',
  'settings.themeImport.error.invalid': 'Ten plik nie jest obsługiwanym motywem kolorów VS Code.',
  'settings.themeImport.error.include': 'Ten motyw odwołuje się do innego pliku. Wyeksportuj go z VS Code poleceniem Developer: Generate Color Theme From Current Settings i zaimportuj wygenerowany JSON.',
  'settings.themeImport.error.size': 'Plik motywu nie może przekraczać 512 KiB.',
  'settings.themeImport.error.background': 'Motyw nie zawiera koloru editor.background. Wyeksportuj pełny motyw kolorów z VS Code.',
  'settings.themeImport.error.save': 'Nie udało się zapisać motywu. Sprawdź połączenie i spróbuj ponownie.',
  'settings.themeImport.error.connection': 'Połączony serwer się zmienił. Motyw nie został zastosowany.',
  'settings.themeImport.error.unsupported': 'Importowanie motywów jest niedostępne w VS Code.',
  'settings.themeImport.error.conflict': 'Ten importowany motyw został zmieniony na serwerze. Nie został nadpisany.',
  ...
  'settings.agents.page.permissionsEditor.mcpTitle': 'Serwery MCP',
  'settings.agents.page.permissionsEditor.mcpInfo': 'Jeden wiersz na każdy serwer MCP z konfiguracji. Reguła obejmuje wszystkie narzędzia serwera. Wyłączone lub niedziałające serwery też są na liście, więc regułę można ustawić z wyprzedzeniem.',
  'settings.agents.page.permissionsEditor.mcpStatus.disabled': 'Wyłączony',
  'settings.agents.page.permissionsEditor.mcpStatus.pending': 'Uruchamianie',
  ...
  "settings.common.actions.close": "Zamknij",
  ...
  "settings.common.status.saveFailedReason": "Nie udało się zapisać: {reason}",
  ...
  'settings.plugins.sidebar.kind.package': 'Pakiet wtyczki',
  ...
  'settings.plugins.status.loaded': 'Załadowany',
  'settings.plugins.status.loadedVersion': 'Załadowany · {version}',
  'settings.plugins.status.failed.title': 'Nie udało się załadować',
  'settings.plugins.status.failed.ref': 'Odwołanie w logu: {ref}',
  'settings.plugins.status.notReported.title': 'Nie załadowany',
  'settings.plugins.status.notReported.description': 'OpenCode nie zgłosił tu tego pluginu. Może nadal się instalować albo inny wpis konfiguracji go wyłącza.',
  'settings.plugins.status.unknown.title': 'Status nieznany',
  'settings.plugins.status.unknown.description': 'Nie udało się odczytać statusu pluginu z OpenCode.',
  'settings.plugins.status.retry': 'Ponów',
  'settings.plugins.status.sidebar.unavailable': 'Status pluginów niedostępny',
  'settings.plugins.update.available.title': 'Dostępna aktualizacja',
  'settings.plugins.update.available.description': 'Nowsze wydanie pasuje do tej specyfikacji. Aktualizacja zainstaluje je ponownie bez zmiany konfiguracji.',
  'settings.plugins.update.action': 'Aktualizuj',
  'settings.plugins.update.running': 'Aktualizowanie…',
  'settings.plugins.update.failed.title': 'Aktualizacja nie powiodła się',
  'settings.plugins.update.toast.done': 'Zaktualizowano {name}',
  'settings.plugins.update.toast.failed': 'Nie udało się zaktualizować {name}',
  'settings.plugins.toast.checkFailed': 'Nie udało się sprawdzić aktualizacji przez OpenCode',
  ...
  'settings.openchamber.about.actions.updateOpenChamberToVersion': 'Aktualizuj OpenChamber do wersji {version}',
  'settings.openchamber.about.actions.updateServerToVersion': 'Aktualizuj serwer OpenChamber do wersji {version}',
  'settings.openchamber.about.actions.updateDesktopToVersion': 'Aktualizuj OpenChamber Desktop do wersji {version}',
  'settings.openchamber.about.actions.updateOpenCodeToVersion': 'Aktualizuj OpenCode do wersji {version}',
  'settings.openchamber.about.actions.checkServerForUpdates': 'Sprawdź aktualizacje serwera',
  'settings.openchamber.about.serviceManagerUpdate': 'OpenChamber {version} jest dostępny. Ten serwer działa pod menedżerem usług i nie może zaktualizować się sam. Uruchom to na serwerze, a potem zrestartuj usługę:',
  'settings.openchamber.about.openCode.installedVersion': 'Zainstalowano OpenCode {version}. Przeładuj OpenCode, aby zacząć go używać.',
  'settings.openchamber.about.openCode.installed': 'Zainstalowano aktualizację OpenCode. Przeładuj OpenCode, aby zacząć jej używać.',
  'settings.openchamber.about.openCode.manualUpdate': 'OpenCode {version} jest dostępny. Zaktualizuj OpenCode w taki sposób, w jaki go zainstalowano, a potem uruchom ponownie OpenChamber.',
  'settings.openchamber.about.native.serverOpenChamberVersion': 'Serwer: OpenChamber {version}',
  'settings.openchamber.about.native.serverOpenCodeVersion': 'Serwer: OpenCode {version}',
  'settings.openchamber.about.native.appVersion': 'Ta aplikacja: {version}',
  'settings.openchamber.about.toast.serverLatestVersion': 'Serwer ma najnowszą wersję OpenChamber',
  ...
  'settings.openchamber.opencodeCli.restart.manualRequired': 'Zapisano na dysku. Uruchom ponownie podłączony serwer OpenCode, aby zastosować zmiany.',
  'settings.openchamber.opencodeCli.restart.failed': 'Nie udało się zastosować zmian konfiguracji.',
  'settings.openchamber.opencodeCli.actions.restart': 'Uruchom ponownie OpenCode',
  'settings.openchamber.opencodeCli.restart.external': 'Ten OpenCode został uruchomiony poza OpenChamber. Uruchom go ponownie tam, gdzie go uruchomiono.',
  'settings.openchamber.opencodeCli.restart.restartFailed': 'Nie udało się ponownie uruchomić OpenCode.',
  ...
  'settings.openchamber.visual.goal.charLimitLabel': 'Limit znaków celu',
  'settings.openchamber.visual.goal.charLimitAria': 'Maksymalna liczba znaków dozwolona dla treści celu',
  'settings.openchamber.visual.goal.maxTurnsLabel': 'Ogranicz liczbę automatycznych kontynuacji',
  'settings.openchamber.visual.goal.maxTurnsAria': 'Ogranicza liczbę automatycznych kontynuacji przed zablokowaniem celu; odznaczenie oznacza brak limitu',
  ...
  'settings.providers.page.custom.models.variantsLabel': 'Poziomy rozumowania',
  'settings.providers.page.custom.models.variantsPlaceholder': 'low, medium, high',
  'settings.providers.page.custom.models.variantsInfo': 'Opcjonalne. Poziomy wysiłku akceptowane przez endpoint, oddzielone przecinkami, np. low, medium, high. Każdy staje się wariantem do wyboru w selektorze modelu.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.agents.page.field.steps': 'Maks. kroków',
  'settings.agents.page.field.stepsTooltip': 'Ile kroków narzędzi agent może wykonać w jednej turze, zanim musi się zatrzymać.',
  'settings.agents.page.field.clearStepsAria': 'Wyczyść maks. kroków',
  'settings.commands.page.field.subagent': 'Uruchom w sesji podrzędnej',
  ...
  'settings.mcp.page.advanced.timeoutCatalogHint': 'Jak długo czekać, aż serwer wyliczy swoje narzędzia.',
  'settings.mcp.page.advanced.timeoutExecutionMs': 'Limit wykonania (ms)',
  'settings.mcp.page.advanced.timeoutExecutionHint': 'Jak długo czekać na zakończenie jednego wywołania narzędzia.',
  'settings.mcp.page.advanced.summary.startup': 'start {value}',
  'settings.mcp.page.advanced.summary.catalog': 'katalog {value}',
  'settings.mcp.page.advanced.summary.execution': 'wykonanie {value}',
  "settings.mcp.page.advanced.codemodeDefaultHint": "Domyślnie decyduje OpenCode: Code Mode jest włączony dla większości serwerów, ale OpenCode wyłącza go dla serwerów z własnym Code Mode, takich jak executor.sh, a od PostHog żąda zwykłych narzędzi zamiast jego własnego Code Mode.",
  "settings.mcp.page.advanced.codemodeOption.default": "Domyślnie (decyduje OpenCode)",
  "settings.mcp.page.advanced.codemodeOption.on": "Włączony",
  "settings.mcp.page.advanced.codemodeOption.off": "Wyłączony",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode włączony",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode wyłączony",
  'settings.mcp.page.advanced.protocol': 'Protokół',
  'settings.mcp.page.advanced.protocolHint': 'Legacy otwiera połączenie uzgodnieniem initialize i obsługuje rewizje protokołu do 2025-11-25. Auto sprawdza rewizję 2026-07-28 i wraca do legacy, gdy serwer jej nie obsługuje. 2026-07-28 wymaga tej rewizji i w przeciwnym razie kończy się błędem.',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy (domyślnie)',
  'settings.mcp.page.advanced.protocolOption.auto': 'Automatycznie',
  'settings.mcp.page.advanced.protocolOption.revision20260728': '2026-07-28',
  'settings.mcp.page.advanced.oauth': 'OAuth',
  'settings.mcp.page.advanced.oauthMetadataUrl': 'Adres URL metadanych serwera autoryzacji',
