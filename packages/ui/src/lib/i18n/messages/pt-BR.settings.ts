...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': 'Importar tema do VS Code (Open VSX)',
  'settings.themeImport.catalogHint': 'Busque temas do VS Code no Open VSX. Temas publicados apenas no Microsoft Marketplace podem não aparecer aqui.',
  'settings.themeImport.search': 'Buscar temas',
  'settings.themeImport.catalogError': 'Não foi possível carregar os temas do Open VSX. Faça a busca novamente.',
  'settings.themeImport.empty': 'Nenhum tema encontrado no Open VSX.',
  'settings.themeImport.back': 'Voltar à busca',
  'settings.themeImport.chooseFile': 'Escolher arquivo JSON',
  'settings.themeImport.importSelected': 'Importar variantes selecionadas',
  'settings.themeImport.installed': 'Importado',
  'settings.themeImport.partialError': 'Não foi possível salvar alguns temas. As importações bem-sucedidas foram mantidas. Você pode tentar novamente as variantes restantes.',
  'settings.themeImport.delete': 'Excluir tema importado {name}',
  'settings.themeImport.deleteError': 'Não foi possível excluir o tema. Ele foi mantido.',
  'settings.themeImport.action': 'Importar tema do VS Code',
  'settings.themeImport.busy': 'Importando tema…',
  'settings.themeImport.hint': 'Importe um tema .json ou .jsonc do VS Code com cores de sintaxe e diff. Ele será salvo no servidor OpenChamber conectado.',
  'settings.themeImport.success': '{name} foi importado.',
  'settings.themeImport.error.invalid': 'Este arquivo não é um tema de cores do VS Code compatível.',
  'settings.themeImport.error.include': 'Este tema faz referência a outro arquivo. Exporte-o no VS Code com Developer: Generate Color Theme From Current Settings e importe o JSON gerado.',
  'settings.themeImport.error.size': 'Os arquivos de tema não podem exceder 512 KiB.',
  'settings.themeImport.error.background': 'Este tema não tem a cor editor.background. Exporte um tema de cores completo do VS Code.',
  'settings.themeImport.error.save': 'Não foi possível salvar o tema. Verifique a conexão e tente novamente.',
  'settings.themeImport.error.connection': 'O servidor conectado mudou. O tema não foi aplicado.',
  'settings.themeImport.error.unsupported': 'A importação de temas não está disponível no VS Code.',
  'settings.themeImport.error.conflict': 'Este tema importado foi editado no servidor. Ele não foi sobrescrito.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.common.actions.close": "Fechar",
  ...
  "settings.common.status.saveFailedReason": "Não foi possível salvar: {reason}",
  ...
  "settings.openchamber.about.actions.updateOpenChamberToVersion": "Atualizar OpenChamber para {version}",
  "settings.openchamber.about.actions.updateServerToVersion": "Atualizar o servidor do OpenChamber para {version}",
  "settings.openchamber.about.actions.updateDesktopToVersion": "Atualizar o OpenChamber Desktop para {version}",
  "settings.openchamber.about.actions.updateOpenCodeToVersion": "Atualizar OpenCode para {version}",
  "settings.openchamber.about.actions.checkServerForUpdates": "Verificar atualizações do servidor",
  "settings.openchamber.about.serviceManagerUpdate": "OpenChamber {version} está disponível. Este servidor roda sob um gerenciador de serviços e não consegue se atualizar sozinho. Execute isto no servidor e depois reinicie o serviço:",
  "settings.openchamber.about.openCode.installedVersion": "OpenCode {version} instalado. Recarregue o OpenCode para começar a usá-lo.",
  "settings.openchamber.about.openCode.installed": "Atualização do OpenCode instalada. Recarregue o OpenCode para começar a usá-la.",
  "settings.openchamber.about.openCode.manualUpdate": "OpenCode {version} está disponível. Atualize o OpenCode do mesmo jeito que você o instalou e depois reinicie o OpenChamber.",
  ...
  "settings.openchamber.about.native.appVersion": "Este app: {version}",
  "settings.openchamber.about.toast.serverLatestVersion": "O servidor está na versão mais recente do OpenChamber",
  ...
  "settings.agents.page.permissionsEditor.mcpInfo": "Uma linha por servidor MCP da sua configuração. A regra cobre todas as ferramentas do servidor. Servidores desativados ou com falha também aparecem, então dá para definir uma regra com antecedência.",
  "settings.agents.page.permissionsEditor.mcpStatus.disabled": "Desativado",
  ...
  "settings.behavior.page.toast.agentsMdChangedOnDisk": "O AGENTS.md foi alterado fora do OpenChamber, então sua edição não foi salva. Copie-a e reabra esta página para carregar o arquivo atual.",
  ...
  "settings.openchamber.opencodeCli.restart.manualRequired": "Salvo no disco. Reinicie o servidor OpenCode conectado para aplicar as alterações.",
  "settings.openchamber.opencodeCli.restart.failed": "Falha ao aplicar as alterações de configuração.",
  "settings.openchamber.opencodeCli.actions.restart": "Reiniciar OpenCode",
  "settings.openchamber.opencodeCli.restart.external": "Este OpenCode foi iniciado fora do OpenChamber. Reinicie-o onde você o iniciou.",
  "settings.openchamber.opencodeCli.restart.restartFailed": "Não foi possível reiniciar o OpenCode.",
  ...
  'settings.plugins.sidebar.kind.package': 'Pacote de plugin',
  ...
  'settings.plugins.status.loaded': 'Carregado',
  'settings.plugins.status.loadedVersion': 'Carregado · {version}',
  'settings.plugins.status.failed.title': 'Falha ao carregar',
  'settings.plugins.status.failed.ref': 'Referência no log: {ref}',
  'settings.plugins.status.notReported.title': 'Não carregado',
  'settings.plugins.status.notReported.description': 'O OpenCode não informou este plugin aqui. Ele pode ainda estar sendo instalado, ou outra entrada da configuração pode desativá-lo.',
  'settings.plugins.status.unknown.title': 'Status desconhecido',
  'settings.plugins.status.unknown.description': 'Não foi possível ler o status do plugin no OpenCode.',
  'settings.plugins.status.retry': 'Tentar novamente',
  'settings.plugins.status.sidebar.unavailable': 'Status dos plugins indisponível',
  'settings.plugins.update.available.title': 'Atualização disponível',
  'settings.plugins.update.available.description': 'Uma versão mais recente corresponde a esta especificação. Atualizar reinstala sem alterar sua configuração.',
  'settings.plugins.update.action': 'Atualizar',
  'settings.plugins.update.running': 'Atualizando…',
  'settings.plugins.update.failed.title': 'Falha na atualização',
  'settings.plugins.update.toast.done': '{name} atualizado',
  'settings.plugins.update.toast.failed': 'Não foi possível atualizar {name}',
  'settings.plugins.toast.checkFailed': 'Não foi possível verificar atualizações pelo OpenCode',
  ...
  "settings.providers.page.custom.models.variantsLabel": "Níveis de raciocínio",
  "settings.providers.page.custom.models.variantsPlaceholder": "low, medium, high",
  "settings.providers.page.custom.models.variantsInfo": "Opcional. Níveis de esforço aceitos pelo endpoint, separados por vírgula, por exemplo low, medium, high. Cada um vira uma variante que você pode escolher no seletor de modelo.",
  ...
  "settings.shared.projectSelector.sheetTitle": "Projeto",
  "settings.shared.projectSelector.searchPlaceholder": "Pesquisar projetos...",
  ...
  "settings.openchamber.defaults.field.sessionWarming": "Manter sessões ociosas aquecidas",
  "settings.openchamber.defaults.field.sessionWarmingInfo": "Alguns provedores esquecem o contexto em cache de uma conversa após alguns minutos de silêncio, então a próxima mensagem fica mais lenta e mais cara. Com isso ativado, o OpenCode envia uma pequena requisição \"OK\" a cada 4 minutos enquanto a sessão está ociosa, por até 30 minutos após sua última mensagem. Cada ping é cobrado como uma requisição pequena. Vale para todos os projetos.",
  ...
  "settings.openchamber.visual.field.noThemesFound": "Nenhum tema encontrado.",
  ...
  "settings.openchamber.visual.goal.charLimitLabel": "Limite de caracteres do objetivo",
  "settings.openchamber.visual.goal.charLimitAria": "Número máximo de caracteres permitido para o objetivo de uma meta",
  "settings.openchamber.visual.goal.maxTurnsLabel": "Limitar turnos de continuação automática",
  "settings.openchamber.visual.goal.maxTurnsAria": "Limita o número de continuações automáticas antes que a meta seja bloqueada; desmarcado significa ilimitado",
  ...
  'settings.commands.page.field.subagent': 'Executar em uma sessão filha',
  ...
  'settings.mcp.page.advanced.timeoutCatalogHint': 'Quanto esperar enquanto o servidor lista suas ferramentas.',
  'settings.mcp.page.advanced.timeoutExecutionMs': 'Tempo de execução (ms)',
  'settings.mcp.page.advanced.timeoutExecutionHint': 'Quanto esperar por uma chamada de ferramenta terminar.',
  "settings.mcp.page.advanced.summary.startup": "inicialização {value}",
  "settings.mcp.page.advanced.summary.catalog": "catálogo {value}",
  "settings.mcp.page.advanced.summary.execution": "execução {value}",
  "settings.mcp.page.advanced.codemodeDefaultHint": "Padrão deixa o OpenCode decidir: o Code Mode fica ativado na maioria dos servidores, mas o OpenCode o desativa nos que têm o seu próprio, como o executor.sh, e pede ao PostHog ferramentas simples em vez do Code Mode dele.",
  "settings.mcp.page.advanced.codemodeOption.default": "Padrão (OpenCode decide)",
  "settings.mcp.page.advanced.codemodeOption.on": "Ativado",
  "settings.mcp.page.advanced.codemodeOption.off": "Desativado",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode ativado",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode desativado",
  'settings.mcp.page.advanced.protocol': 'Protocolo',
  'settings.mcp.page.advanced.protocolHint': 'Legacy abre a conexão com o handshake initialize e fala revisões do protocolo até 2025-11-25. Auto testa a revisão 2026-07-28 e volta para legacy quando o servidor não a suporta. 2026-07-28 exige essa revisão e falha caso contrário.',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy (padrão)',
  ...
  'settings.mcp.page.advanced.oauthMetadataUrl': 'URL de metadados do servidor de autorização',
