...
export const dict: Record<I18nKey, string> = {
  ...
  "opencodeCompatibility.outdatedLocal": "OpenCode {version} がインストールされています。このバージョンの OpenChamber には OpenCode {minimum} 以降が必要です。",
  "opencodeCompatibility.outdatedExternal": "接続先のサーバーは OpenCode {version} を使用しています。OpenCode {minimum} 以降に更新してから再接続してください。",
  "opencodeCompatibility.update": "OpenCode を更新",
  "opencodeCompatibility.local": "OpenCode {version} がインストールされています。このバージョンの OpenChamber には OpenCode v2 が必要です。",
  "opencodeCompatibility.external": "接続先のサーバーは OpenCode {version} を使用しています。そのサーバーに OpenCode v2 をインストールしてから再接続してください。",
  "opencodeCompatibility.installDescription": "OpenChamber が公式インストーラーで v2 をインストールし、OpenCode を再起動します。",
  "opencodeCompatibility.install": "OpenCode v2 に更新",
  "opencodeCompatibility.reconnect": "再確認",
  "opencodeCompatibility.guide": "インストールガイド",
  "opencodeCompatibility.installing": "OpenCode v2 をインストール中…",
  "opencodeCompatibility.reconnecting": "再接続中…",
  "opencodeCompatibility.failed": "操作を完了できませんでした。再試行するか、インストールガイドに従って再接続してください。",
  ...
  'smallModel.toast.unavailable.title': 'Small Model を利用できません',
  'smallModel.toast.unavailable.description': '設定 → セッション → Small Model で別のモデルを選び、もう一度お試しください。',
  ...
  'chat.message.context.showQuoteSource': '元のメッセージで表示',
  ...
  'sessions.sidebar.header.viewMode.timeline': 'タイムライン',
  ...
  'sessions.sidebar.session.moveToWorktree.tooltip': '現在のブランチから新しいworktreeを作成し、このセッションとサブセッションをそこへ移動します。未コミットの変更は元のworktreeに残ります。',
  ...
  'sessions.sidebar.session.rename.error': 'セッション名を変更できませんでした。{detail}',
  'sessions.sidebar.session.action.upstreamErrorWithRef': 'OpenCode が {status} {name} を返しました（ref {ref}）。OpenCode のログでこの ref を検索してください。',
  'sessions.sidebar.session.action.upstreamError': 'OpenCode が {status} を返しました: {message}',
  'sessions.sidebar.session.action.noDetails': '詳細なし',
  ...
  "diffView.fileTree.showAsList": "リスト表示",
  "diffView.fileTree.showAsTree": "ツリー表示",
  "diffView.fileTree.collapseDirectoryAria": "{path} を折りたたむ",
  "diffView.fileTree.expandDirectoryAria": "{path} を展開",
  "diffView.fileTree.resize": "ファイルツリーの幅を変更",
  ...
  'chat.goal.button.noSmallModel': 'ゴールには Small Model が必要です。モデルプロバイダーにサインインするか、設定 → セッションで選択してください。',
  'chat.goal.dialog.noSmallModel': 'ゴールの進捗確認には Small Model が必要です。モデルプロバイダーにサインインするか、設定 → セッションで選択してください。',
  ...
  'aboutDialog.appVersionLabel': 'アプリのバージョン {version}',
  ...
  'chat.textSelection.comment.save': 'コメントを保存',
  ...
  'chat.messageBody.actions.branchMenu': 'この回答から続ける',
  ...
  'chat.toolPart.questionsAsked': '質問数: {count}',
  'chat.toolPart.filesCount': 'ファイル数: {count}',
  'chat.toolPart.moreToolCalls': '他 +{count} 件',
  ...
  'onboarding.localSetup.description': 'OpenCode v2 CLIをインストールして続行します。',
  ...
  'onboarding.localSetup.intro': 'OpenCode v2 CLIをインストールして続行します。',
  "onboarding.localSetup.docs.windows": "インストールガイド",
  "onboarding.localSetup.docs.default": "インストールガイド",
  ...
  'onboarding.localSetup.status.watching': 'OpenCode v2を待機中',
  ...
  "projectConfigError.toast.title": "OpenCode はこのプロジェクトの設定を読み込めません",
  "projectConfigError.toast.unknownFile": "プロジェクト設定",
  "projectConfigError.toast.hint": "ファイルを修正してから再試行してください。他のプロジェクトは引き続き使用できます。",
  "projectConfigError.toast.retry": "再試行",
  "projectConfigError.toast.retrying": "再試行中…",
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamberがサーバーに接続できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  'startup.initRecovery.loadAgentsFailed': 'サーバーは実行中ですが、OpenCodeがエージェントを読み込めませんでした。原因を解決してから再試行してください。',
  'startup.initRecovery.unexpected': 'OpenChamberの起動を完了できませんでした。原因を解決してから再試行してください。',
  ...
  'opencodeUpdate.toast.available.manualDescription': 'バージョン{version}が利用可能です。インストール時と同じ方法で OpenCode を更新し、OpenChamber を再起動してください。',
  ...
  'chat.formDock.waiting': 'あと {count} 件が待機中',
  'chat.formDock.back': '戻る',
  'chat.formDock.expandAria': '質問を展開',
  'chat.formDock.collapseAria': '質問を折りたたむ',
  'chat.formDock.stepAria': '質問 {index}: {title}',
  'chat.formDock.linkInfo': 'リンクを開いてから続けてください。',
  'chat.permissionCard.title': '許可が必要です',
  ...
  'chat.permissionCard.showDetails': "詳細を表示",
  'chat.permissionDock.expandAria': '許可リクエストを展開',
  'chat.permissionDock.collapseAria': '許可リクエストを折りたたむ',
  'chat.permissionDock.stepAria': 'リクエスト {index}: {tool}',
  'chat.permissionCard.allowOnce': '今回のみ許可',
  'chat.permissionCard.alwaysAllow': '常に許可',
  'chat.permissionCard.alwaysAllowPatterns': '常に: {patterns}',
  'chat.permissionCard.deny': '拒否',
  'chat.permissionCard.replaceAll': 'すべての箇所を置き換えます',
