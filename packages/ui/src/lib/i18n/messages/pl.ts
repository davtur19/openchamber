...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.showQuoteSource': 'Pokaż w oryginalnej wiadomości',
  ...
  'chat.textSelection.comment.save': 'Zapisz komentarz',
  ...
  "projectConfigError.toast.title": "OpenCode nie może wczytać konfiguracji tego projektu",
  "projectConfigError.toast.unknownFile": "Konfiguracja projektu",
  "projectConfigError.toast.hint": "Popraw plik i spróbuj ponownie. Pozostałe projekty działają normalnie.",
  "projectConfigError.toast.retry": "Spróbuj ponownie",
  "projectConfigError.toast.retrying": "Ponawianie…",
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamber nie mógł połączyć się z serwerem. Sprawdź, czy serwer działa, a następnie spróbuj ponownie.',
  'startup.initRecovery.loadAgentsFailed': 'Serwer działa, ale OpenCode nie mógł wczytać agentów. Spróbuj ponownie po usunięciu przyczyny.',
  'startup.initRecovery.unexpected': 'OpenChamber nie mógł dokończyć uruchamiania. Spróbuj ponownie po usunięciu przyczyny.',
  ...
  'aboutDialog.appVersionLabel': 'Wersja aplikacji {version}',
  ...
  'chat.toolPart.blocked': 'Zablokowano',
  ...
  "diffView.fileTree.showAsList": "Widok listy",
  "diffView.fileTree.showAsTree": "Widok drzewa",
  "diffView.fileTree.collapseDirectoryAria": "Zwiń {path}",
  "diffView.fileTree.expandDirectoryAria": "Rozwiń {path}",
  "diffView.fileTree.resize": "Zmień szerokość drzewa plików",
