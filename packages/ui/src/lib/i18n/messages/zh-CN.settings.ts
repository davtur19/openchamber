...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.about.actions.updateOpenChamberToVersion': '将 OpenChamber 更新到 {version}',
  'settings.openchamber.about.actions.updateServerToVersion': '将 OpenChamber 服务器更新到 {version}',
  'settings.openchamber.about.actions.updateDesktopToVersion': '将 OpenChamber 桌面版更新到 {version}',
  'settings.openchamber.about.actions.updateOpenCodeToVersion': '将 OpenCode 更新到 {version}',
  'settings.openchamber.about.actions.checkServerForUpdates': '检查服务器更新',
  'settings.openchamber.about.serviceManagerUpdate': 'OpenChamber {version} 已可用。此服务器由服务管理器运行，无法自行更新。请在服务器上运行以下命令，然后重启服务：',
  'settings.openchamber.about.openCode.installedVersion': '已安装 OpenCode {version}。重新加载 OpenCode 以开始使用。',
  'settings.openchamber.about.openCode.installed': '已安装 OpenCode 更新。重新加载 OpenCode 以开始使用。',
  'settings.openchamber.about.openCode.manualUpdate': 'OpenCode {version} 已可用。请按照你安装 OpenCode 的方式更新它，然后重启 OpenChamber。',
  'settings.openchamber.about.native.serverOpenChamberVersion': '服务器：OpenChamber {version}',
  'settings.openchamber.about.native.serverOpenCodeVersion': '服务器：OpenCode {version}',
  'settings.openchamber.about.native.appVersion': '此应用：{version}',
  'settings.openchamber.about.toast.serverLatestVersion': '服务器已是最新版 OpenChamber',
  ...
  'settings.openchamber.spaces.title': '隔离空间',
  ...
  'settings.openchamber.opencodeCli.actions.restart': '重启 OpenCode',
  'settings.openchamber.opencodeCli.restart.external': '此 OpenCode 是在 OpenChamber 之外启动的。请在启动它的地方重启。',
  'settings.openchamber.opencodeCli.restart.restartFailed': '无法重启 OpenCode。',
  ...
  'settings.openchamber.visual.goal.charLimitLabel': '目标字符数限制',
  'settings.openchamber.visual.goal.charLimitAria': '目标说明允许的最大字符数',
  'settings.openchamber.visual.goal.maxTurnsLabel': '限制自动继续轮数',
  'settings.openchamber.visual.goal.maxTurnsAria': '限制目标被判定为阻塞前的自动继续次数；取消勾选表示不限',
  ...
  "settings.mcp.page.advanced.codemodeDefaultHint": "默认由 OpenCode 决定：大多数服务器启用 Code Mode，但对于自带 Code Mode 的服务器（如 executor.sh），OpenCode 会关闭它，并要求 PostHog 提供普通工具而不是其自带的 Code Mode。",
  "settings.mcp.page.advanced.codemodeOption.default": "默认（由 OpenCode 决定）",
  "settings.mcp.page.advanced.codemodeOption.on": "开启",
  "settings.mcp.page.advanced.codemodeOption.off": "关闭",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode 开启",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode 关闭",
