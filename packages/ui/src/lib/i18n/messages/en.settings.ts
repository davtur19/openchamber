...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': 'Import VS Code theme (Open VSX)',
  'settings.themeImport.catalogHint': 'Search Open VSX for VS Code themes. Themes published only in Microsoft Marketplace may not appear here.',
  'settings.themeImport.search': 'Search themes',
  'settings.themeImport.catalogError': 'Could not load themes from Open VSX. Try searching again.',
  'settings.themeImport.empty': 'No themes found in Open VSX.',
  'settings.themeImport.back': 'Back to search',
  'settings.themeImport.chooseFile': 'Choose JSON file',
  'settings.themeImport.importSelected': 'Import selected variants',
  'settings.themeImport.installed': 'Imported',
  'settings.themeImport.partialError': 'Some themes could not be saved. Successful imports were kept. You can retry the remaining variants.',
  'settings.themeImport.delete': 'Delete imported theme {name}',
  'settings.themeImport.deleteError': 'Could not delete the theme. It has been kept.',
  'settings.themeImport.action': 'Import VS Code theme',
  'settings.themeImport.busy': 'Importing theme…',
  'settings.themeImport.hint': 'Import a VS Code .json or .jsonc theme, including syntax and diff colors. Saved on the connected OpenChamber server.',
  'settings.themeImport.success': 'Imported {name}.',
  'settings.themeImport.error.invalid': 'This file is not a supported VS Code color theme.',
  'settings.themeImport.error.include': 'This theme references another file. Export it from VS Code with Developer: Generate Color Theme From Current Settings, then import the generated JSON.',
  'settings.themeImport.error.size': 'Theme files must be no larger than 512 KiB.',
  'settings.themeImport.error.background': 'This theme has no editor.background color. Export a complete color theme from VS Code.',
  'settings.themeImport.error.save': 'Could not save the theme. Check the connection and try again.',
  'settings.themeImport.error.connection': 'The connected server changed. The theme was not applied.',
  'settings.themeImport.error.unsupported': 'Theme import is not available in VS Code.',
  'settings.themeImport.error.conflict': 'This imported theme was edited on the server. It was not overwritten.',
  ...
  "settings.common.status.saveFailedReason": "Couldn't save: {reason}",
  ...
  'settings.openchamber.about.actions.updateOpenChamberToVersion': 'Update OpenChamber to {version}',
  'settings.openchamber.about.actions.updateServerToVersion': 'Update OpenChamber server to {version}',
  'settings.openchamber.about.actions.updateDesktopToVersion': 'Update OpenChamber desktop to {version}',
  'settings.openchamber.about.actions.updateOpenCodeToVersion': 'Update OpenCode to {version}',
  'settings.openchamber.about.actions.checkServerForUpdates': 'Check server for updates',
  'settings.openchamber.about.serviceManagerUpdate': 'OpenChamber {version} is available. This server runs under a service manager and can\'t update itself. Run this on the server, then restart the service:',
  'settings.openchamber.about.openCode.installedVersion': 'OpenCode {version} installed. Reload OpenCode to start using it.',
  'settings.openchamber.about.openCode.installed': 'OpenCode update installed. Reload OpenCode to start using it.',
  'settings.openchamber.about.openCode.manualUpdate': 'OpenCode {version} is available. Update OpenCode the way you installed it, then restart OpenChamber.',
  'settings.openchamber.about.native.serverOpenChamberVersion': 'Server: OpenChamber {version}',
  'settings.openchamber.about.native.serverOpenCodeVersion': 'Server: OpenCode {version}',
  'settings.openchamber.about.native.appVersion': 'This app: {version}',
  'settings.openchamber.about.toast.serverLatestVersion': 'The server runs the latest OpenChamber',
  ...
  'settings.agents.page.permissionsEditor.mcpTitle': 'MCP servers',
  'settings.agents.page.permissionsEditor.mcpInfo': 'One row per MCP server from your config. The rule covers every tool the server exposes. Servers that are disabled or failing are listed too, so a rule can be set ahead of time.',
  'settings.agents.page.permissionsEditor.mcpStatus.disabled': 'Disabled',
  'settings.agents.page.permissionsEditor.mcpStatus.pending': 'Starting',
  ...
  'settings.openchamber.opencodeCli.restart.manualRequired': 'Saved on disk. Restart your connected OpenCode server to apply the changes.',
  'settings.openchamber.opencodeCli.restart.failed': 'Failed to apply configuration changes.',
  'settings.openchamber.opencodeCli.actions.restart': 'Restart OpenCode',
  'settings.openchamber.opencodeCli.restart.external': 'This OpenCode was started outside OpenChamber. Restart it where you started it.',
  'settings.openchamber.opencodeCli.restart.restartFailed': 'Couldn\'t restart OpenCode.',
  ...
  'settings.plugins.sidebar.kind.package': 'Plugin package',
  ...
  'settings.plugins.status.loadedVersion': 'Loaded · {version}',
  'settings.plugins.status.failed.title': 'Failed to load',
  'settings.plugins.status.failed.ref': 'Log reference: {ref}',
  'settings.plugins.status.notReported.title': 'Not loaded',
  'settings.plugins.status.notReported.description': "OpenCode hasn't reported this plugin here. It may still be installing, or another config entry may disable it.",
  'settings.plugins.status.unknown.title': 'Status unknown',
  'settings.plugins.status.unknown.description': "Couldn't read plugin status from OpenCode.",
  'settings.plugins.status.retry': 'Retry',
  'settings.plugins.status.sidebar.unavailable': 'Plugin status unavailable',
  'settings.plugins.update.available.title': 'Update available',
  'settings.plugins.update.available.description': 'A newer release matches this spec. Updating reinstalls it without changing your config.',
  'settings.plugins.update.action': 'Update',
  'settings.plugins.update.running': 'Updating…',
  'settings.plugins.update.failed.title': 'Update failed',
  'settings.plugins.update.toast.done': 'Updated {name}',
  'settings.plugins.update.toast.failed': "Couldn't update {name}",
  'settings.plugins.toast.checkFailed': "Couldn't check for updates through OpenCode",
  ...
  'settings.providers.page.custom.models.variantsLabel': 'Reasoning levels',
  'settings.providers.page.custom.models.variantsPlaceholder': 'low, medium, high',
  'settings.providers.page.custom.models.variantsInfo': 'Optional. Comma-separated effort levels the endpoint accepts, e.g. low, medium, high. Each one becomes a variant you can pick in the model selector.',
  ...
  'settings.shared.projectSelector.sheetTitle': 'Project',
  'settings.shared.projectSelector.searchPlaceholder': 'Search projects...',
  ...
  'settings.openchamber.visual.field.searchThemes': 'Search themes...',
  'settings.openchamber.visual.field.noThemesFound': 'No themes found.',
  ...
  'settings.openchamber.visual.goal.charLimitLabel': 'Objective character limit',
  'settings.openchamber.visual.goal.charLimitAria': 'Maximum characters accepted for a goal objective',
  'settings.openchamber.visual.goal.maxTurnsLabel': 'Limit auto-continuation turns',
  'settings.openchamber.visual.goal.maxTurnsAria': 'Cap the number of automatic continuations before a goal settles as blocked; unchecked means unlimited',
  ...
  'settings.commands.page.field.subagent': 'Run in a child session',
  ...
  'settings.mcp.page.advanced.timeoutCatalogHint': 'How long to wait while the server lists its tools.',
  'settings.mcp.page.advanced.timeoutExecutionMs': 'Execution timeout (ms)',
  'settings.mcp.page.advanced.timeoutExecutionHint': 'How long to wait for a single tool call to finish.',
  'settings.mcp.page.advanced.summary.startup': 'startup {value}',
  'settings.mcp.page.advanced.summary.catalog': 'catalog {value}',
  'settings.mcp.page.advanced.summary.execution': 'execution {value}',
  "settings.mcp.page.advanced.codemodeDefaultHint": "Default lets OpenCode decide: Code Mode is on for most servers, but OpenCode turns it off for servers that bring their own, such as executor.sh, and asks PostHog for plain tools instead of its own Code Mode.",
  "settings.mcp.page.advanced.codemodeOption.default": "Default (OpenCode decides)",
  "settings.mcp.page.advanced.codemodeOption.on": "On",
  "settings.mcp.page.advanced.codemodeOption.off": "Off",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode on",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode off",
  'settings.mcp.page.advanced.protocol': 'Protocol',
  'settings.mcp.page.advanced.protocolHint': 'Legacy opens the connection with the initialize handshake and speaks protocol revisions up to 2025-11-25. Auto probes for the 2026-07-28 revision and falls back to legacy when the server does not support it. 2026-07-28 requires that revision and fails otherwise.',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy (default)',
  ...
  'settings.mcp.page.advanced.oauthMetadataUrl': 'Authorization server metadata URL',
