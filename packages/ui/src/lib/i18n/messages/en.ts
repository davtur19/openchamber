...
export const dict = {
  ...
  "opencodeCompatibility.outdatedLocal": "OpenCode {version} is installed. This version of OpenChamber requires OpenCode {minimum} or newer.",
  "opencodeCompatibility.outdatedExternal": "Your connected server is running OpenCode {version}. Update it to OpenCode {minimum} or newer, then reconnect.",
  "opencodeCompatibility.update": "Update OpenCode",
  "opencodeCompatibility.local": "OpenCode {version} is installed. This version of OpenChamber requires OpenCode v2.",
  "opencodeCompatibility.external": "Your connected server is running OpenCode {version}. Install OpenCode v2 on that server, then reconnect.",
  "opencodeCompatibility.installDescription": "OpenChamber will install v2 using the official installer, then restart OpenCode.",
  "opencodeCompatibility.install": "Update to OpenCode v2",
  "opencodeCompatibility.reconnect": "Check again",
  "opencodeCompatibility.guide": "Installation guide",
  "opencodeCompatibility.installing": "Installing OpenCode v2…",
  "opencodeCompatibility.reconnecting": "Reconnecting…",
  "opencodeCompatibility.failed": "Could not complete the operation. Try again, or follow the installation guide and reconnect.",
  ...
  'smallModel.toast.unavailable.title': 'Small Model unavailable',
  'smallModel.toast.unavailable.description': 'Choose another model in Settings → Sessions → Small Model and try again.',
  ...
  'chat.message.context.showQuoteSource': 'Show in the original message',
  ...
  'sessions.sidebar.header.viewMode.label': 'View',
  'sessions.sidebar.header.viewMode.projects': 'Grouped',
  'sessions.sidebar.header.viewMode.timeline': 'Timeline',
  ...
  'sessions.sidebar.session.moveToWorktree.outcomeUnknown': 'The new worktree was kept: the move may still complete on the server.',
  ...
  'sessions.sidebar.session.moveToWorktree.tooltip': 'Creates a new worktree from the current branch and moves this session and its sub-sessions there. Uncommitted changes stay in the source worktree.',
  ...
  'sessions.sidebar.session.rename.error': 'Could not rename the session. {detail}',
  'sessions.sidebar.session.action.upstreamErrorWithRef': 'OpenCode answered {status} {name} (ref {ref}). Search the OpenCode log for this ref.',
  'sessions.sidebar.session.action.upstreamError': 'OpenCode answered {status}: {message}',
  'sessions.sidebar.session.action.noDetails': 'no details',
  ...
  'diffView.fileTree.showAsList': 'List view',
  'diffView.fileTree.showAsTree': 'Tree view',
  'diffView.fileTree.collapseDirectoryAria': 'Collapse {path}',
  'diffView.fileTree.expandDirectoryAria': 'Expand {path}',
  'diffView.fileTree.resize': 'Resize file tree',
  ...
  'chat.goal.button.noSmallModel': 'Goals need a Small Model. Sign in to a model provider or pick one in Settings → Sessions.',
  'chat.goal.dialog.noSmallModel': 'Goals need a Small Model to check progress. Sign in to a model provider or pick one in Settings → Sessions.',
  ...
  'aboutDialog.appVersionLabel': 'App version {version}',
  ...
  'chat.textSelection.comment.save': 'Save comment',
  ...
  'chat.messageBody.actions.branchMenu': 'Continue from this answer',
  ...
  'chat.toolPart.moreToolCalls': '+{count} more',
  ...
  'onboarding.localSetup.description': 'Install OpenCode v2 CLI to continue.',
  ...
  'onboarding.localSetup.intro': 'Install OpenCode v2 CLI to continue.',
  "onboarding.localSetup.docs.windows": "Installation guide",
  "onboarding.localSetup.docs.default": "Installation guide",
  ...
  'onboarding.localSetup.status.watching': 'Waiting for OpenCode v2',
  ...
  'projectConfigError.toast.title': "OpenCode can't load this project's config",
  'projectConfigError.toast.unknownFile': 'Project config',
  'projectConfigError.toast.hint': 'Fix the file, then retry. Other projects keep working.',
  'projectConfigError.toast.retry': 'Retry',
  'projectConfigError.toast.retrying': 'Retrying…',
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamber could not reach its server. Check that the server is running, then retry.',
  'startup.initRecovery.loadAgentsFailed': 'The server is running, but OpenCode could not load agents. Retry once the cause is fixed.',
  'startup.initRecovery.unexpected': 'OpenChamber could not finish starting. Retry once the cause is fixed.',
  ...
  'opencodeUpdate.toast.available.manualDescription': 'Version {version} available. Update OpenCode the way you installed it, then restart OpenChamber.',
  ...
  'chat.formDock.back': 'Back',
  'chat.formDock.expandAria': 'Expand the question',
  'chat.formDock.collapseAria': 'Collapse the question',
  'chat.formDock.stepAria': 'Question {index}: {title}',
  'chat.formDock.linkInfo': 'Open the link, then continue.',
  ...
  'chat.permissionCard.showDetails': "Show details",
