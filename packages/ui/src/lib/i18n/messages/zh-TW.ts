...
export const dict: Record<I18nKey, string> = {
  ...
  "opencodeCompatibility.outdatedLocal": "已安裝 OpenCode {version}。此版本的 OpenChamber 需要 OpenCode {minimum} 或更新版本。",
  "opencodeCompatibility.outdatedExternal": "連線的伺服器正在執行 OpenCode {version}。請將其更新至 OpenCode {minimum} 或更新版本，然後重新連線。",
  "opencodeCompatibility.update": "更新 OpenCode",
  "opencodeCompatibility.local": "已安裝 OpenCode {version}。此版本的 OpenChamber 需要 OpenCode v2。",
  "opencodeCompatibility.external": "連線的伺服器正在執行 OpenCode {version}。請在該伺服器上安裝 OpenCode v2，然後重新連線。",
  "opencodeCompatibility.installDescription": "OpenChamber 將使用官方安裝程式安裝 v2，然後重新啟動 OpenCode。",
  "opencodeCompatibility.install": "更新至 OpenCode v2",
  "opencodeCompatibility.reconnect": "重新檢查",
  "opencodeCompatibility.guide": "安裝指南",
  "opencodeCompatibility.installing": "正在安裝 OpenCode v2…",
  "opencodeCompatibility.reconnecting": "正在重新連線…",
  "opencodeCompatibility.failed": "無法完成操作。請重試，或按照安裝指南操作後重新連線。",
  ...
  'smallModel.toast.unavailable.title': 'Small Model 無法使用',
  'smallModel.toast.unavailable.description': '請在 設定 → 工作階段 → Small Model 中選擇另一個模型後重試。',
  ...
  'chat.message.context.showQuoteSource': '在原始訊息中顯示',
  ...
  'sessions.sidebar.header.viewMode.timeline': '時間軸',
  ...
  'sessions.sidebar.session.moveToWorktree.tooltip': '從目前分支建立新工作樹，並將此工作階段及其子工作階段移至其中。未提交的變更會留在來源工作樹中。',
  ...
  'sessions.sidebar.session.rename.error': '無法重新命名會話。{detail}',
  'sessions.sidebar.session.action.upstreamErrorWithRef': 'OpenCode 回應 {status} {name}（ref {ref}）。請在 OpenCode 日誌中搜尋此 ref。',
  'sessions.sidebar.session.action.upstreamError': 'OpenCode 回應 {status}：{message}',
  'sessions.sidebar.session.action.noDetails': '無詳細資訊',
  ...
  "diffView.fileTree.showAsList": "清單檢視",
  "diffView.fileTree.showAsTree": "樹狀檢視",
  "diffView.fileTree.collapseDirectoryAria": "摺疊 {path}",
  "diffView.fileTree.expandDirectoryAria": "展開 {path}",
  "diffView.fileTree.resize": "調整檔案樹寬度",
  ...
  'chat.goal.button.noSmallModel': '目標需要 Small Model。請登入模型供應商，或在 設定 → 工作階段 中選擇一個。',
  'chat.goal.dialog.noSmallModel': '目標需要 Small Model 來檢查進度。請登入模型供應商，或在 設定 → 工作階段 中選擇一個。',
  ...
  'aboutDialog.appVersionLabel': 'App 版本 {version}',
  ...
  'chat.textSelection.comment.save': '儲存留言',
  ...
  'chat.messageBody.actions.branchMenu': '從此回答繼續',
  ...
  'chat.toolPart.questionsAsked': '已提問：{count}',
  'chat.toolPart.filesCount': '檔案數：{count}',
  'chat.toolPart.moreToolCalls': '還有 +{count} 個',
  ...
  'onboarding.localSetup.description': '安裝 OpenCode v2 CLI 以繼續。',
  ...
  'onboarding.localSetup.intro': '安裝 OpenCode v2 CLI 以繼續。',
  "onboarding.localSetup.docs.windows": "安裝指南",
  "onboarding.localSetup.docs.default": "安裝指南",
  ...
  "projectConfigError.toast.title": "OpenCode 無法載入此專案的設定",
  "projectConfigError.toast.unknownFile": "專案設定",
  "projectConfigError.toast.hint": "修正該檔案後重試。其他專案不受影響。",
  "projectConfigError.toast.retry": "重試",
  "projectConfigError.toast.retrying": "正在重試…",
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamber 無法連線至伺服器。請檢查伺服器是否正在執行，然後重試。',
  'startup.initRecovery.loadAgentsFailed': '伺服器正在執行，但 OpenCode 無法載入代理。請在解決問題後重試。',
  'startup.initRecovery.unexpected': 'OpenChamber 未能完成啟動。請在解決問題後重試。',
  ...
  'opencodeUpdate.toast.available.manualDescription': '版本 {version} 可安裝。請以安裝時的方式更新 OpenCode，然後重新啟動 OpenChamber。',
  ...
  'chat.workStatus.sections.reorder': '拖曳 {label} 以重新排序',
  'chat.workStatus.sections.dragInstructions': '按空白鍵選取區塊，使用方向鍵移動，再按空白鍵放下。按 Escape 鍵取消。',
  'chat.workStatus.sections.position': '{label}，第 {position} 項，共 {count} 項。',
  ...
  'chat.formDock.waiting': '還有 {count} 個等待中',
  'chat.formDock.back': '上一步',
  'chat.formDock.expandAria': '展開問題',
  'chat.formDock.collapseAria': '收合問題',
  'chat.formDock.stepAria': '問題 {index}：{title}',
  'chat.formDock.linkInfo': '開啟連結後再繼續。',
  'chat.permissionCard.title': '需要權限',
  ...
  'chat.permissionCard.showDetails': "顯示詳細資訊",
  'chat.permissionDock.expandAria': '展開權限請求',
  'chat.permissionDock.collapseAria': '收合權限請求',
  'chat.permissionDock.stepAria': '請求 {index}：{tool}',
  'chat.permissionCard.allowOnce': '允許一次',
  'chat.permissionCard.alwaysAllow': '一律允許',
