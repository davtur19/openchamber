...
export const dict = {
  ...
  "opencodeCompatibility.outdatedLocal": "OpenCode {version} est installé. Cette version d’OpenChamber nécessite OpenCode {minimum} ou une version plus récente.",
  "opencodeCompatibility.outdatedExternal": "Le serveur connecté utilise OpenCode {version}. Mettez-le à jour vers OpenCode {minimum} ou une version plus récente, puis reconnectez-vous.",
  "opencodeCompatibility.update": "Mettre à jour OpenCode",
  "opencodeCompatibility.local": "OpenCode {version} est installé. Cette version d’OpenChamber nécessite OpenCode v2.",
  "opencodeCompatibility.external": "Le serveur connecté utilise OpenCode {version}. Installez OpenCode v2 sur ce serveur, puis reconnectez-vous.",
  "opencodeCompatibility.installDescription": "OpenChamber installera la v2 avec le programme officiel, puis redémarrera OpenCode.",
  "opencodeCompatibility.install": "Passer à OpenCode v2",
  "opencodeCompatibility.reconnect": "Vérifier à nouveau",
  "opencodeCompatibility.guide": "Guide d’installation",
  "opencodeCompatibility.installing": "Installation d’OpenCode v2…",
  "opencodeCompatibility.reconnecting": "Reconnexion…",
  "opencodeCompatibility.failed": "L’opération n’a pas pu être terminée. Réessayez ou suivez le guide d’installation, puis reconnectez-vous.",
  ...
  'smallModel.toast.unavailable.title': 'Small Model indisponible',
  'smallModel.toast.unavailable.description': 'Choisissez un autre modèle dans Paramètres → Sessions → Small Model et réessayez.',
  ...
  'chat.message.context.showQuoteSource': 'Afficher dans le message original',
  ...
  'multirun.launcher.toast.partialFailure': 'Certaines sessions n’ont pas pu être créées. Échecs : {failed}.',
  ...
  'sessions.sidebar.header.actions.sortWorktrees': 'Trier les worktrees',
  'sessions.sidebar.header.worktreeSort.recent': 'Activité récente',
  ...
  'sessions.sidebar.header.viewMode.timeline': 'Chronologie',
  ...
  'sessions.sidebar.session.moveToWorktree.outcomeUnknown': 'Le nouveau worktree a été conservé : le déplacement peut encore aboutir côté serveur.',
  ...
  'sessions.sidebar.session.moveToWorktree.tooltip': 'Crée un nouveau worktree depuis la branche actuelle et y déplace cette session et ses sous-sessions. Les modifications non validées restent dans le worktree source.',
  ...
  'sessions.sidebar.session.rename.error': 'Impossible de renommer la session. {detail}',
  'sessions.sidebar.session.action.upstreamErrorWithRef': 'OpenCode a répondu {status} {name} (réf {ref}). Cherchez cette réf dans le journal OpenCode.',
  'sessions.sidebar.session.action.upstreamError': 'OpenCode a répondu {status} : {message}',
  'sessions.sidebar.session.action.noDetails': 'aucun détail',
  ...
  'sessions.sidebar.group.empty.startSession': 'Démarrer une session',
  ...
  "diffView.fileTree.showAsList": "Vue en liste",
  "diffView.fileTree.showAsTree": "Vue en arborescence",
  "diffView.fileTree.collapseDirectoryAria": "Réduire {path}",
  "diffView.fileTree.expandDirectoryAria": "Développer {path}",
  "diffView.fileTree.resize": "Redimensionner l’arborescence des fichiers",
  ...
  'chat.goal.button.noSmallModel': 'Les objectifs nécessitent un Small Model. Connectez-vous à un fournisseur de modèles ou choisissez-en un dans Paramètres → Sessions.',
  'chat.goal.dialog.noSmallModel': 'Les objectifs nécessitent un Small Model pour vérifier la progression. Connectez-vous à un fournisseur de modèles ou choisissez-en un dans Paramètres → Sessions.',
  ...
  'aboutDialog.appVersionLabel': 'Version de l\'app {version}',
  ...
  'chat.textSelection.comment.save': 'Enregistrer le commentaire',
  ...
  'chat.toolPart.questionsAsked': 'Questions posées : {count}',
  'chat.toolPart.filesCount': 'Fichiers : {count}',
  'chat.toolPart.moreToolCalls': '+{count} de plus',
  ...
  'onboarding.localSetup.description': 'Installez OpenCode v2 CLI pour continuer.',
  ...
  'onboarding.localSetup.intro': 'Installez OpenCode v2 CLI pour continuer.',
  "onboarding.localSetup.docs.windows": "Guide d’installation",
  "onboarding.localSetup.docs.default": "Guide d’installation",
  ...
  'onboarding.localSetup.status.watching': 'En attendant OpenCode v2',
  ...
  "projectConfigError.toast.title": "OpenCode ne peut pas charger la configuration de ce projet",
  "projectConfigError.toast.unknownFile": "Configuration du projet",
  "projectConfigError.toast.hint": "Corrigez le fichier, puis réessayez. Les autres projets continuent de fonctionner.",
  "projectConfigError.toast.retry": "Réessayer",
  "projectConfigError.toast.retrying": "Nouvelle tentative…",
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamber n’a pas pu joindre son serveur. Vérifiez que le serveur est en cours d’exécution, puis réessayez.',
  'startup.initRecovery.loadAgentsFailed': 'Le serveur fonctionne, mais OpenCode n’a pas pu charger les agents. Réessayez une fois la cause corrigée.',
  'startup.initRecovery.unexpected': 'OpenChamber n’a pas pu terminer son démarrage. Réessayez une fois la cause corrigée.',
  ...
  'opencodeUpdate.toast.available.manualDescription': 'Version {version} disponible. Mettez à jour OpenCode comme vous l’avez installé, puis redémarrez OpenChamber.',
  ...
  'chat.formDock.progress': '{current} sur {total}',
  'chat.formDock.waiting': '{count} de plus en attente',
  'chat.formDock.back': 'Retour',
  'chat.formDock.expandAria': 'Développer la question',
  'chat.formDock.collapseAria': 'Réduire la question',
  'chat.formDock.stepAria': 'Question {index} : {title}',
  'chat.formDock.linkInfo': 'Ouvrez le lien, puis continuez.',
  'chat.permissionCard.title': 'Autorisation requise',
  ...
  'chat.permissionCard.showDetails': "Afficher les détails",
  'chat.permissionDock.expandAria': 'Déplier la demande d’autorisation',
  'chat.permissionDock.collapseAria': 'Replier la demande d’autorisation',
  'chat.permissionDock.stepAria': 'Demande {index} : {tool}',
  'chat.permissionCard.allowOnce': 'Autoriser une fois',
  'chat.permissionCard.alwaysAllow': 'Toujours autoriser',
