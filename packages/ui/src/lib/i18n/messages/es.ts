...
export const dict: Record<I18nKey, string> = {
  ...
  "opencodeCompatibility.outdatedLocal": "Tienes instalado OpenCode {version}. Esta versión de OpenChamber requiere OpenCode {minimum} o posterior.",
  "opencodeCompatibility.outdatedExternal": "El servidor conectado usa OpenCode {version}. Actualízalo a OpenCode {minimum} o posterior y vuelve a conectarte.",
  "opencodeCompatibility.update": "Actualizar OpenCode",
  "opencodeCompatibility.local": "Tienes instalado OpenCode {version}. Esta versión de OpenChamber requiere OpenCode v2.",
  "opencodeCompatibility.external": "El servidor conectado usa OpenCode {version}. Instala OpenCode v2 en ese servidor y vuelve a conectarte.",
  "opencodeCompatibility.installDescription": "OpenChamber instalará v2 con el instalador oficial y después reiniciará OpenCode.",
  "opencodeCompatibility.install": "Actualizar a OpenCode v2",
  "opencodeCompatibility.reconnect": "Comprobar de nuevo",
  "opencodeCompatibility.guide": "Guía de instalación",
  "opencodeCompatibility.installing": "Instalando OpenCode v2…",
  "opencodeCompatibility.reconnecting": "Conectando de nuevo…",
  "opencodeCompatibility.failed": "No se pudo completar la operación. Inténtalo de nuevo o sigue la guía de instalación y vuelve a conectarte.",

  'sessions.aiRename.action': 'Renombrar con IA',
  'sessions.aiRename.generating': 'Generando el título de la sesión...',
  'sessions.aiRename.checking': 'Comprobando los turnos completados...',
  'sessions.aiRename.noCompletedTurns': 'Disponible después de la primera respuesta completada.',
  'sessions.aiRename.failed': 'No se pudo renombrar la sesión. Revisa la configuración del modelo pequeño e inténtalo de nuevo.',
  'sessions.aiRename.unsupported': 'El cambio de nombre con IA no está disponible en VS Code.',
  'smallModel.toast.unavailable.title': 'Small Model no disponible',
  'smallModel.toast.unavailable.description': 'Elige otro modelo en Ajustes → Sesiones → Small Model e inténtalo de nuevo.',
  ...
  'chat.message.context.showQuoteSource': 'Mostrar en el mensaje original',
  ...
  "sessions.sidebar.header.worktreeSort.recent": "Actividad reciente",
  ...
  "sessions.sidebar.header.viewMode.label": "Vista",
  "sessions.sidebar.header.viewMode.projects": "Agrupado",
  "sessions.sidebar.header.viewMode.timeline": "Cronología",
  ...
  "sessions.sidebar.session.moveToWorktree.tooltip": 'Crea un nuevo worktree a partir de la rama actual y mueve allí esta sesión y sus subsesiones. Los cambios sin confirmar se quedan en el worktree de origen.',
  ...
  "sessions.sidebar.session.rename.error": "No se pudo renombrar la sesión. {detail}",
  "sessions.sidebar.session.action.upstreamErrorWithRef": "OpenCode respondió {status} {name} (ref {ref}). Busca esta ref en el registro de OpenCode.",
  "sessions.sidebar.session.action.upstreamError": "OpenCode respondió {status}: {message}",
  "sessions.sidebar.session.action.noDetails": "sin detalles",
  ...
  "sessions.sidebar.group.empty.startSession": "Iniciar una sesión",
  ...
  "diffView.fileTree.showAsList": "Vista de lista",
  "diffView.fileTree.showAsTree": "Vista de árbol",
  "diffView.fileTree.collapseDirectoryAria": "Contraer {path}",
  "diffView.fileTree.expandDirectoryAria": "Expandir {path}",
  "diffView.fileTree.resize": "Cambiar el ancho del árbol de archivos",
  ...
  "chat.goal.button.noSmallModel": "Los objetivos necesitan un Small Model. Inicia sesión en un proveedor de modelos o elige uno en Ajustes → Sesiones.",
  "chat.goal.dialog.noSmallModel": "Los objetivos necesitan un Small Model para comprobar el progreso. Inicia sesión en un proveedor de modelos o elige uno en Ajustes → Sesiones.",
  ...
  "aboutDialog.appVersionLabel": "Versión de la app {version}",
  ...
  "chat.changedFiles.actions.showMore": "Mostrar más ({count})",
  "chat.changedFiles.actions.collapse": "Contraer",
  ...
  "chat.textSelection.comment.save": "Guardar comentario",
  ...
  "chat.messageBody.actions.branchMenu": "Continuar desde esta respuesta",
  ...
  "chat.toolPart.questionsAsked": 'Preguntas realizadas: {count}',
  "chat.toolPart.filesCount": 'Archivos: {count}',
  "chat.toolPart.moreToolCalls": '+{count} más',
  ...
  "onboarding.localSetup.description": "Instala la CLI de OpenCode v2 para continuar.",
  ...
  "onboarding.localSetup.intro": "Instala la CLI de OpenCode v2 para continuar.",
  "onboarding.localSetup.docs.windows": "Guía de instalación",
  "onboarding.localSetup.docs.default": "Guía de instalación",
  ...
  "onboarding.localSetup.status.watching": "Esperando OpenCode v2",
  ...
  "projectConfigError.toast.title": "OpenCode no puede cargar la configuración de este proyecto",
  "projectConfigError.toast.unknownFile": "Configuración del proyecto",
  "projectConfigError.toast.hint": "Corrige el archivo y vuelve a intentarlo. Los demás proyectos siguen funcionando.",
  "projectConfigError.toast.retry": "Reintentar",
  "projectConfigError.toast.retrying": "Reintentando…",
  ...
  "startup.initRecovery.serverUnreachable": "OpenChamber no pudo conectar con su servidor. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  "startup.initRecovery.loadAgentsFailed": "El servidor está en ejecución, pero OpenCode no pudo cargar los agentes. Vuelve a intentarlo cuando se haya resuelto la causa.",
  "startup.initRecovery.unexpected": "OpenChamber no pudo terminar de iniciarse. Vuelve a intentarlo cuando se haya resuelto la causa.",
  ...
  "opencodeUpdate.toast.available.manualDescription": 'Versión {version} disponible. Actualiza OpenCode de la misma forma en que lo instalaste y luego reinicia OpenChamber.',
  ...
  'chat.formDock.waiting': '{count} más en espera',
  'chat.formDock.back': 'Atrás',
  'chat.formDock.expandAria': 'Expandir la pregunta',
  'chat.formDock.collapseAria': 'Contraer la pregunta',
  'chat.formDock.stepAria': 'Pregunta {index}: {title}',
  'chat.formDock.linkInfo': 'Abre el enlace y luego continúa.',
  'chat.permissionCard.title': 'Permiso necesario',
  ...
  'chat.permissionCard.showDetails': "Mostrar detalles",
  'chat.permissionDock.expandAria': 'Expandir la solicitud de permiso',
  'chat.permissionDock.collapseAria': 'Contraer la solicitud de permiso',
  'chat.permissionDock.stepAria': 'Solicitud {index}: {tool}',
  'chat.permissionCard.allowOnce': 'Permitir una vez',
  'chat.permissionCard.alwaysAllow': 'Permitir siempre',
