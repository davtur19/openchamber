...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.showQuoteSource': '在原消息中显示',
  ...
  'sessions.sidebar.header.actions.sortWorktrees': '排序工作树',
  'sessions.sidebar.header.worktreeSort.recent': '最近活动',
  ...
  "diffView.fileTree.showAsList": "列表视图",
  "diffView.fileTree.showAsTree": "树形视图",
  "diffView.fileTree.collapseDirectoryAria": "折叠 {path}",
  "diffView.fileTree.expandDirectoryAria": "展开 {path}",
  "diffView.fileTree.resize": "调整文件树宽度",
  ...
  'aboutDialog.appVersionLabel': '应用版本 {version}',
  ...
  'chat.textSelection.comment.save': '保存评论',
  ...
  'commandPalette.item.restartOpenCode': '重启 OpenCode',
  ...
  "projectConfigError.toast.title": "OpenCode 无法加载此项目的配置",
  "projectConfigError.toast.unknownFile": "项目配置",
  "projectConfigError.toast.hint": "修复该文件后重试。其他项目不受影响。",
  "projectConfigError.toast.retry": "重试",
  "projectConfigError.toast.retrying": "正在重试…",
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamber 无法连接到服务器。请检查服务器是否正在运行，然后重试。',
  'startup.initRecovery.loadAgentsFailed': '服务器正在运行，但 OpenCode 未能加载代理。请在解决问题后重试。',
  'startup.initRecovery.unexpected': 'OpenChamber 未能完成启动。请在解决问题后重试。',
