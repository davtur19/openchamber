...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': '匯入 VS Code 佈景主題 (Open VSX)',
  'settings.themeImport.catalogHint': '在 Open VSX 中搜尋 VS Code 佈景主題。僅發佈在 Microsoft Marketplace 的佈景主題可能不會顯示。',
  'settings.themeImport.search': '搜尋佈景主題',
  'settings.themeImport.catalogError': '無法從 Open VSX 載入佈景主題。請重新搜尋。',
  'settings.themeImport.empty': '在 Open VSX 中找不到佈景主題。',
  'settings.themeImport.back': '返回搜尋',
  'settings.themeImport.chooseFile': '選擇 JSON 檔案',
  'settings.themeImport.importSelected': '匯入所選變體',
  'settings.themeImport.installed': '已匯入',
  'settings.themeImport.partialError': '部分佈景主題無法儲存。已成功匯入的佈景主題會保留。您可以重試其餘變體。',
  'settings.themeImport.delete': '刪除已匯入的佈景主題 {name}',
  'settings.themeImport.deleteError': '無法刪除佈景主題，佈景主題已保留。',
  'settings.themeImport.action': '匯入 VS Code 主題',
  'settings.themeImport.busy': '正在匯入主題…',
  'settings.themeImport.hint': '匯入 VS Code 的 .json 或 .jsonc 主題，包含語法與 diff 色彩。主題會儲存在已連線的 OpenChamber 伺服器上。',
  'settings.themeImport.success': '已匯入 {name}。',
  'settings.themeImport.error.invalid': '此檔案不是支援的 VS Code 色彩主題。',
  'settings.themeImport.error.include': '此主題參照其他檔案。請在 VS Code 執行 Developer: Generate Color Theme From Current Settings，再匯入產生的 JSON。',
  'settings.themeImport.error.size': '主題檔案不能超過 512 KiB。',
  'settings.themeImport.error.background': '此主題沒有 editor.background 色彩。請從 VS Code 匯出完整的色彩主題。',
  'settings.themeImport.error.save': '無法儲存主題。請檢查連線後再試一次。',
  'settings.themeImport.error.connection': '連線的伺服器已變更。未套用主題。',
  'settings.themeImport.error.unsupported': 'VS Code 中不支援匯入主題。',
  'settings.themeImport.error.conflict': '此匯入的主題已在伺服器上被編輯，未覆寫原檔案。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  "settings.common.actions.close": "關閉",
  ...
  "settings.common.status.saveFailedReason": "無法儲存：{reason}",
  ...
  'settings.openchamber.about.actions.updateOpenChamberToVersion': '將 OpenChamber 更新到 {version}',
  'settings.openchamber.about.actions.updateServerToVersion': '將 OpenChamber 伺服器更新到 {version}',
  'settings.openchamber.about.actions.updateDesktopToVersion': '將 OpenChamber 桌面版更新到 {version}',
  'settings.openchamber.about.actions.updateOpenCodeToVersion': '將 OpenCode 更新到 {version}',
  'settings.openchamber.about.actions.checkServerForUpdates': '檢查伺服器更新',
  'settings.openchamber.about.serviceManagerUpdate': 'OpenChamber {version} 已可使用。此伺服器由服務管理員執行，無法自行更新。請在伺服器上執行以下指令，然後重新啟動服務：',
  'settings.openchamber.about.openCode.installedVersion': '已安裝 OpenCode {version}。重新載入 OpenCode 以開始使用。',
  'settings.openchamber.about.openCode.installed': '已安裝 OpenCode 更新。重新載入 OpenCode 以開始使用。',
  'settings.openchamber.about.openCode.manualUpdate': 'OpenCode {version} 已可使用。請依照你安裝 OpenCode 的方式更新它，然後重新啟動 OpenChamber。',
  'settings.openchamber.about.native.serverOpenChamberVersion': '伺服器：OpenChamber {version}',
  'settings.openchamber.about.native.serverOpenCodeVersion': '伺服器：OpenCode {version}',
  'settings.openchamber.about.native.appVersion': '此應用程式：{version}',
  'settings.openchamber.about.toast.serverLatestVersion': '伺服器已是最新版 OpenChamber',
  ...
  'settings.agents.page.permissionsEditor.mcpTitle': 'MCP 伺服器',
  'settings.agents.page.permissionsEditor.mcpInfo': '設定中的每個 MCP 伺服器一列。規則涵蓋該伺服器提供的所有工具。已停用或失敗的伺服器也會列出，方便事先設定規則。',
  'settings.agents.page.permissionsEditor.mcpStatus.disabled': '已停用',
  'settings.agents.page.permissionsEditor.mcpStatus.pending': '啟動中',
  ...
  'settings.behavior.page.toast.agentsMdChangedOnDisk': 'AGENTS.md 已在 OpenChamber 之外被修改，因此你的編輯未儲存。請先複製你的內容，然後重新開啟此頁面以載入目前的檔案。',
  ...
  'settings.openchamber.opencodeCli.restart.manualRequired': '已儲存到磁碟。請重新啟動已連線的 OpenCode 伺服器以套用變更。',
  'settings.openchamber.opencodeCli.restart.failed': '套用設定變更失敗。',
  'settings.openchamber.opencodeCli.actions.restart': '重新啟動 OpenCode',
  'settings.openchamber.opencodeCli.restart.external': '此 OpenCode 是在 OpenChamber 之外啟動的。請在啟動它的地方重新啟動。',
  'settings.openchamber.opencodeCli.restart.restartFailed': '無法重新啟動 OpenCode。',
  ...
  'settings.projects.page.field.projectAgent': '專案 Agent',
  ...
  'settings.providers.page.custom.models.variantsLabel': '推理等級',
  'settings.providers.page.custom.models.variantsPlaceholder': 'low, medium, high',
  'settings.providers.page.custom.models.variantsInfo': '選填。以逗號分隔填寫端點支援的推理強度,例如 low, medium, high。每個等級都會成為模型選擇器中可選的變體。',
  ...
  'settings.openchamber.visual.field.searchThemes': '搜尋佈景主題...',
  'settings.openchamber.visual.field.noThemesFound': '找不到佈景主題。',
  ...
  'settings.openchamber.visual.goal.charLimitLabel': '目標字元數限制',
  'settings.openchamber.visual.goal.charLimitAria': '目標說明允許的最大字元數',
  'settings.openchamber.visual.goal.maxTurnsLabel': '限制自動繼續輪數',
  'settings.openchamber.visual.goal.maxTurnsAria': '限制目標被判定為阻塞前的自動繼續次數；取消勾選表示不限',
  ...
  'settings.plugins.sidebar.kind.package': '外掛套件',
  ...
  'settings.plugins.status.loaded': '已載入',
  'settings.plugins.status.loadedVersion': '已載入 · {version}',
  'settings.plugins.status.failed.title': '載入失敗',
  'settings.plugins.status.failed.ref': '日誌參照：{ref}',
  'settings.plugins.status.notReported.title': '未載入',
  'settings.plugins.status.notReported.description': 'OpenCode 尚未在此回報這個外掛。它可能仍在安裝，或被其他設定項目停用。',
  'settings.plugins.status.unknown.title': '狀態未知',
  'settings.plugins.status.unknown.description': '無法從 OpenCode 讀取外掛狀態。',
  'settings.plugins.status.retry': '重試',
  'settings.plugins.status.sidebar.unavailable': '外掛狀態無法取得',
  'settings.plugins.update.available.title': '有可用更新',
  'settings.plugins.update.available.description': '有更新的版本符合此規格。更新會重新安裝它，不會變更你的設定。',
  'settings.plugins.update.action': '更新',
  'settings.plugins.update.running': '正在更新…',
  'settings.plugins.update.failed.title': '更新失敗',
  'settings.plugins.update.toast.done': '已更新 {name}',
  'settings.plugins.update.toast.failed': '無法更新 {name}',
  'settings.plugins.toast.checkFailed': '無法透過 OpenCode 檢查更新',
  ...
  'settings.commands.page.field.subagent': '在子工作階段中執行',
  ...
  'settings.mcp.page.advanced.timeoutCatalogHint': '等待伺服器列出其工具的時間。',
  'settings.mcp.page.advanced.timeoutExecutionMs': '執行逾時（毫秒）',
  'settings.mcp.page.advanced.timeoutExecutionHint': '等待單次工具呼叫完成的時間。',
  'settings.mcp.page.advanced.summary.startup': '啟動 {value}',
  'settings.mcp.page.advanced.summary.catalog': '目錄 {value}',
  'settings.mcp.page.advanced.summary.execution': '執行 {value}',
  "settings.mcp.page.advanced.codemodeDefaultHint": "預設由 OpenCode 決定：大多數伺服器啟用 Code Mode，但對於自帶 Code Mode 的伺服器（如 executor.sh），OpenCode 會關閉它，並要求 PostHog 提供一般工具而不是其自帶的 Code Mode。",
  "settings.mcp.page.advanced.codemodeOption.default": "預設（由 OpenCode 決定）",
  "settings.mcp.page.advanced.codemodeOption.on": "開啟",
  "settings.mcp.page.advanced.codemodeOption.off": "關閉",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode 開啟",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode 關閉",
  'settings.mcp.page.advanced.protocol': '通訊協定',
  'settings.mcp.page.advanced.protocolHint': 'Legacy 以 initialize 交握建立連線，支援至 2025-11-25 為止的通訊協定修訂。Auto 會探測 2026-07-28 修訂，伺服器不支援時回退至 legacy。2026-07-28 強制使用該修訂，否則連線失敗。',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy（預設）',
  ...
  'settings.mcp.page.advanced.oauthMetadataUrl': '授權伺服器中繼資料 URL',
