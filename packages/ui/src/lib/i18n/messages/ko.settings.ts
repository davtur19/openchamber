...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': 'VS Code 테마 가져오기 (Open VSX)',
  'settings.themeImport.catalogHint': 'Open VSX에서 VS Code 테마를 검색합니다. Microsoft Marketplace에만 게시된 테마는 표시되지 않을 수 있습니다.',
  'settings.themeImport.search': '테마 검색',
  'settings.themeImport.catalogError': 'Open VSX에서 테마를 불러오지 못했습니다. 다시 검색해 주세요.',
  'settings.themeImport.empty': 'Open VSX에서 테마를 찾지 못했습니다.',
  'settings.themeImport.back': '검색으로 돌아가기',
  'settings.themeImport.chooseFile': 'JSON 파일 선택',
  'settings.themeImport.importSelected': '선택한 변형 가져오기',
  'settings.themeImport.installed': '가져옴',
  'settings.themeImport.partialError': '일부 테마를 저장하지 못했습니다. 성공한 가져오기는 유지됩니다. 나머지 변형을 다시 시도할 수 있습니다.',
  'settings.themeImport.delete': '가져온 테마 {name} 삭제',
  'settings.themeImport.deleteError': '테마를 삭제하지 못했습니다. 테마가 유지됩니다.',
  'settings.themeImport.action': 'VS Code 테마 가져오기',
  'settings.themeImport.busy': '테마 가져오는 중…',
  'settings.themeImport.hint': '구문 및 diff 색상을 포함한 VS Code .json 또는 .jsonc 테마를 가져옵니다. 연결된 OpenChamber 서버에 저장됩니다.',
  'settings.themeImport.success': '{name} 테마를 가져왔습니다.',
  'settings.themeImport.error.invalid': '이 파일은 지원되는 VS Code 색 테마가 아닙니다.',
  'settings.themeImport.error.include': '이 테마는 다른 파일을 참조합니다. VS Code에서 Developer: Generate Color Theme From Current Settings 명령으로 내보낸 후 생성된 JSON을 가져오세요.',
  'settings.themeImport.error.size': '테마 파일은 512 KiB 이하여야 합니다.',
  'settings.themeImport.error.background': '이 테마에는 editor.background 색상이 없습니다. VS Code에서 전체 색 테마를 내보내세요.',
  'settings.themeImport.error.save': '테마를 저장하지 못했습니다. 연결을 확인하고 다시 시도하세요.',
  'settings.themeImport.error.connection': '연결된 서버가 변경되었습니다. 테마를 적용하지 않았습니다.',
  'settings.themeImport.error.unsupported': 'VS Code에서는 테마 가져오기를 사용할 수 없습니다.',
  'settings.themeImport.error.conflict': '이 가져온 테마는 서버에서 편집되었습니다. 덮어쓰지 않았습니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  "settings.common.actions.close": "닫기",
  ...
  "settings.common.status.saveFailedReason": "저장하지 못했습니다: {reason}",
  ...
  'settings.openchamber.about.actions.updateOpenChamberToVersion': 'OpenChamber를 {version}으로 업데이트',
  'settings.openchamber.about.actions.updateServerToVersion': 'OpenChamber 서버를 {version}으로 업데이트',
  'settings.openchamber.about.actions.updateDesktopToVersion': 'OpenChamber 데스크톱을 {version}으로 업데이트',
  'settings.openchamber.about.actions.updateOpenCodeToVersion': 'OpenCode를 {version}으로 업데이트',
  'settings.openchamber.about.actions.checkServerForUpdates': '서버 업데이트 확인',
  'settings.openchamber.about.serviceManagerUpdate': 'OpenChamber {version}을 사용할 수 있습니다. 이 서버는 서비스 관리자에서 실행되므로 스스로 업데이트할 수 없습니다. 서버에서 다음 명령을 실행한 뒤 서비스를 다시 시작하세요:',
  'settings.openchamber.about.openCode.installedVersion': 'OpenCode {version}이 설치되었습니다. 사용하려면 OpenCode를 다시 로드하세요.',
  'settings.openchamber.about.openCode.installed': 'OpenCode 업데이트가 설치되었습니다. 사용하려면 OpenCode를 다시 로드하세요.',
  'settings.openchamber.about.openCode.manualUpdate': 'OpenCode {version}을 사용할 수 있습니다. 설치했던 방식으로 OpenCode를 업데이트한 뒤 OpenChamber를 다시 시작하세요.',
  'settings.openchamber.about.native.serverOpenChamberVersion': '서버: OpenChamber {version}',
  'settings.openchamber.about.native.serverOpenCodeVersion': '서버: OpenCode {version}',
  'settings.openchamber.about.native.appVersion': '이 앱: {version}',
  'settings.openchamber.about.toast.serverLatestVersion': '서버가 최신 OpenChamber를 사용 중입니다',
  ...
  'settings.agents.page.permissionsEditor.mcpTitle': 'MCP 서버',
  'settings.agents.page.permissionsEditor.mcpInfo': '설정에 있는 MCP 서버마다 한 줄씩 표시됩니다. 규칙은 서버가 제공하는 모든 도구에 적용됩니다. 비활성화되었거나 실패한 서버도 표시되므로 규칙을 미리 정할 수 있습니다.',
  'settings.agents.page.permissionsEditor.mcpStatus.disabled': '비활성화됨',
  'settings.agents.page.permissionsEditor.mcpStatus.pending': '시작 중',
  ...
  'settings.openchamber.sessionRetention.tooltip': '마지막 활동을 기준으로 보관되지 않은 세션을 보관하거나 삭제합니다. 최근 세션 5개, 열려 있는 세션, 실행 중인 세션과 공유된 세션은 유지됩니다. 보관된 세션도 유지됩니다. 상위 세션을 삭제하면 보호된 하위 세션도 삭제되는 경우 상위 세션을 유지합니다.',
  ...
  'settings.openchamber.opencodeCli.restart.manualRequired': '디스크에 저장되었습니다. 연결된 OpenCode 서버를 다시 시작하여 변경 사항을 적용하세요.',
  'settings.openchamber.opencodeCli.restart.failed': '구성 변경을 적용하지 못했습니다.',
  'settings.openchamber.opencodeCli.actions.restart': 'OpenCode 다시 시작',
  'settings.openchamber.opencodeCli.restart.external': '이 OpenCode는 OpenChamber 외부에서 시작되었습니다. 시작한 곳에서 다시 시작하세요.',
  'settings.openchamber.opencodeCli.restart.restartFailed': 'OpenCode를 다시 시작하지 못했습니다.',
  ...
  'settings.plugins.sidebar.kind.package': '플러그인 패키지',
  ...
  'settings.plugins.status.loaded': '로드됨',
  'settings.plugins.status.loadedVersion': '로드됨 · {version}',
  'settings.plugins.status.failed.title': '로드 실패',
  'settings.plugins.status.failed.ref': '로그 참조: {ref}',
  'settings.plugins.status.notReported.title': '로드되지 않음',
  'settings.plugins.status.notReported.description': 'OpenCode가 여기에서 이 플러그인을 보고하지 않았습니다. 아직 설치 중이거나 다른 설정 항목이 비활성화했을 수 있습니다.',
  'settings.plugins.status.unknown.title': '상태 알 수 없음',
  'settings.plugins.status.unknown.description': 'OpenCode에서 플러그인 상태를 읽지 못했습니다.',
  'settings.plugins.status.retry': '다시 시도',
  'settings.plugins.status.sidebar.unavailable': '플러그인 상태를 사용할 수 없음',
  'settings.plugins.update.available.title': '업데이트 있음',
  'settings.plugins.update.available.description': '이 지정과 일치하는 새 릴리스가 있습니다. 업데이트하면 설정을 바꾸지 않고 다시 설치합니다.',
  'settings.plugins.update.action': '업데이트',
  'settings.plugins.update.running': '업데이트 중…',
  'settings.plugins.update.failed.title': '업데이트 실패',
  'settings.plugins.update.toast.done': '{name} 업데이트됨',
  'settings.plugins.update.toast.failed': '{name}을(를) 업데이트하지 못했습니다',
  'settings.plugins.toast.checkFailed': 'OpenCode로 업데이트를 확인하지 못했습니다',
  ...
  'settings.providers.page.custom.models.variantsLabel': '추론 수준',
  'settings.providers.page.custom.models.variantsPlaceholder': 'low, medium, high',
  'settings.providers.page.custom.models.variantsInfo': '선택 사항. 엔드포인트가 지원하는 추론 수준을 쉼표로 구분해 입력하세요(예: low, medium, high). 각 수준은 모델 선택기에서 고를 수 있는 변형이 됩니다.',
  ...
  'settings.openchamber.visual.goal.charLimitLabel': '목표 문자 수 제한',
  'settings.openchamber.visual.goal.charLimitAria': '목표 설명에 허용되는 최대 문자 수',
  'settings.openchamber.visual.goal.maxTurnsLabel': '자동 연속 실행 횟수 제한',
  'settings.openchamber.visual.goal.maxTurnsAria': '목표가 차단 상태가 되기 전까지 자동 연속 실행 횟수를 제한합니다. 선택 해제 시 무제한입니다',
  ...
  'settings.commands.page.field.subagent': '하위 세션에서 실행',
  ...
  'settings.mcp.page.advanced.timeoutCatalogHint': '서버가 도구 목록을 반환할 때까지 기다리는 시간입니다.',
  'settings.mcp.page.advanced.timeoutExecutionMs': '실행 제한 시간(ms)',
  'settings.mcp.page.advanced.timeoutExecutionHint': '도구 호출 하나가 끝날 때까지 기다리는 시간입니다.',
  'settings.mcp.page.advanced.summary.startup': '시작 {value}',
  'settings.mcp.page.advanced.summary.catalog': '카탈로그 {value}',
  'settings.mcp.page.advanced.summary.execution': '실행 {value}',
  "settings.mcp.page.advanced.codemodeDefaultHint": "기본값은 OpenCode가 결정합니다. 대부분의 서버에서 Code Mode가 켜지지만, executor.sh처럼 자체 Code Mode가 있는 서버에서는 끄고, PostHog에는 자체 Code Mode 대신 일반 도구를 요청합니다.",
  "settings.mcp.page.advanced.codemodeOption.default": "기본값(OpenCode가 결정)",
  "settings.mcp.page.advanced.codemodeOption.on": "켜기",
  "settings.mcp.page.advanced.codemodeOption.off": "끄기",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode 켜짐",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode 꺼짐",
  'settings.mcp.page.advanced.protocol': '프로토콜',
  'settings.mcp.page.advanced.protocolHint': 'Legacy는 initialize 핸드셰이크로 연결을 열고 2025-11-25까지의 프로토콜 리비전을 사용합니다. Auto는 2026-07-28 리비전을 시도하고 서버가 지원하지 않으면 legacy로 돌아갑니다. 2026-07-28은 해당 리비전을 요구하며 지원되지 않으면 실패합니다.',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy(기본값)',
  'settings.mcp.page.advanced.protocolOption.auto': '자동',
  'settings.mcp.page.advanced.protocolOption.revision20260728': '2026-07-28',
  'settings.mcp.page.advanced.oauth': 'OAuth',
  'settings.mcp.page.advanced.oauthMetadataUrl': '인증 서버 메타데이터 URL',
