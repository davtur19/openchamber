...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': 'Імпортувати тему VS Code (Open VSX)',
  'settings.themeImport.catalogHint': 'Пошук тем VS Code у каталозі Open VSX. Теми, опубліковані лише в Microsoft Marketplace, можуть бути відсутні.',
  'settings.themeImport.search': 'Пошук тем',
  'settings.themeImport.catalogError': 'Не вдалося завантажити теми з Open VSX. Спробуйте пошук ще раз.',
  'settings.themeImport.empty': 'В Open VSX не знайдено тем.',
  'settings.themeImport.back': 'Назад до пошуку',
  'settings.themeImport.chooseFile': 'Вибрати JSON-файл',
  'settings.themeImport.importSelected': 'Імпортувати вибрані варіанти',
  'settings.themeImport.installed': 'Імпортовано',
  'settings.themeImport.partialError': 'Деякі теми не вдалося зберегти. Успішні імпорти збережено. Можна повторити імпорт решти варіантів.',
  'settings.themeImport.delete': 'Видалити імпортовану тему {name}',
  'settings.themeImport.deleteError': 'Не вдалося видалити тему. Вона залишилася на місці.',
  'settings.themeImport.action': 'Імпортувати тему VS Code',
  'settings.themeImport.busy': 'Імпортування теми…',
  'settings.themeImport.hint': 'Імпорт теми VS Code з .json або .jsonc разом із кольорами синтаксису й diff. Тема зберігається на підключеному сервері OpenChamber.',
  'settings.themeImport.success': 'Імпортовано {name}.',
  'settings.themeImport.error.invalid': 'Цей файл не є підтримуваною колірною темою VS Code.',
  'settings.themeImport.error.include': 'Тема посилається на інший файл. Експортуйте її з VS Code командою Developer: Generate Color Theme From Current Settings та імпортуйте отриманий JSON.',
  'settings.themeImport.error.size': 'Розмір файлу теми не має перевищувати 512 KiB.',
  'settings.themeImport.error.background': 'У темі немає кольору editor.background. Експортуйте повну колірну тему з VS Code.',
  'settings.themeImport.error.save': 'Не вдалося зберегти тему. Перевірте з’єднання та спробуйте ще раз.',
  'settings.themeImport.error.connection': 'Підключений сервер змінився. Тему не застосовано.',
  'settings.themeImport.error.unsupported': 'Імпорт тем недоступний у VS Code.',
  'settings.themeImport.error.conflict': 'Цю імпортовану тему було змінено на сервері. Її не перезаписано.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.common.actions.close": "Закрити",
  ...
  "settings.common.status.saveFailedReason": "Не вдалося зберегти: {reason}",
  ...
  "settings.openchamber.about.actions.updateOpenChamberToVersion": "Оновити OpenChamber до {version}",
  "settings.openchamber.about.actions.updateServerToVersion": "Оновити сервер OpenChamber до {version}",
  "settings.openchamber.about.actions.updateDesktopToVersion": "Оновити OpenChamber Desktop до {version}",
  "settings.openchamber.about.actions.updateOpenCodeToVersion": "Оновити OpenCode до {version}",
  "settings.openchamber.about.actions.checkServerForUpdates": "Перевірити оновлення сервера",
  "settings.openchamber.about.serviceManagerUpdate": "Доступна версія OpenChamber {version}. Цей сервер працює під менеджером служб і не може оновитися сам. Виконайте це на сервері, а потім перезапустіть службу:",
  "settings.openchamber.about.openCode.installedVersion": "OpenCode {version} встановлено. Перезавантажте OpenCode, щоб почати ним користуватися.",
  "settings.openchamber.about.openCode.installed": "Оновлення OpenCode встановлено. Перезавантажте OpenCode, щоб почати ним користуватися.",
  "settings.openchamber.about.openCode.manualUpdate": "Доступна версія OpenCode {version}. Оновіть OpenCode так само, як встановлювали, а потім перезапустіть OpenChamber.",
  ...
  "settings.openchamber.about.native.appVersion": "Цей застосунок: {version}",
  "settings.openchamber.about.toast.serverLatestVersion": "На сервері найновіша версія OpenChamber",
  ...
  "settings.agents.page.permissionsEditor.mcpTitle": "MCP-сервери",
  "settings.agents.page.permissionsEditor.mcpInfo": "Один рядок на кожен MCP-сервер із конфігурації. Правило охоплює всі інструменти сервера. Вимкнені та несправні сервери теж у списку, тож правило можна задати наперед.",
  "settings.agents.page.permissionsEditor.mcpStatus.disabled": "Вимкнено",
  "settings.agents.page.permissionsEditor.mcpStatus.pending": "Запускається",
  ...
  "settings.openchamber.opencodeCli.restart.manualRequired": "Збережено на диску. Перезапустіть підключений сервер OpenCode, щоб застосувати зміни.",
  "settings.openchamber.opencodeCli.restart.failed": "Не вдалося застосувати зміни конфігурації.",
  "settings.openchamber.opencodeCli.actions.restart": "Перезапустити OpenCode",
  "settings.openchamber.opencodeCli.restart.external": "Цей OpenCode запущено поза OpenChamber. Перезапустіть його там, де запускали.",
  "settings.openchamber.opencodeCli.restart.restartFailed": "Не вдалося перезапустити OpenCode.",
  ...
  'settings.plugins.sidebar.kind.package': 'Пакет плагіна',
  ...
  'settings.plugins.status.loaded': 'Завантажено',
  'settings.plugins.status.loadedVersion': 'Завантажено · {version}',
  'settings.plugins.status.failed.title': 'Не вдалося завантажити',
  'settings.plugins.status.failed.ref': 'Посилання в журналі: {ref}',
  'settings.plugins.status.notReported.title': 'Не завантажено',
  'settings.plugins.status.notReported.description': 'OpenCode не повідомив про цей плагін тут. Можливо, він ще встановлюється, або інший запис конфігурації його вимикає.',
  'settings.plugins.status.unknown.title': 'Стан невідомий',
  'settings.plugins.status.unknown.description': 'Не вдалося прочитати стан плагіна з OpenCode.',
  'settings.plugins.status.retry': 'Повторити',
  'settings.plugins.status.sidebar.unavailable': 'Стан плагінів недоступний',
  'settings.plugins.update.available.title': 'Є оновлення',
  'settings.plugins.update.available.description': 'Новіший реліз відповідає цій специфікації. Оновлення перевстановить його без зміни конфігурації.',
  'settings.plugins.update.action': 'Оновити',
  'settings.plugins.update.running': 'Оновлення…',
  'settings.plugins.update.failed.title': 'Не вдалося оновити',
  'settings.plugins.update.toast.done': '{name} оновлено',
  'settings.plugins.update.toast.failed': 'Не вдалося оновити {name}',
  'settings.plugins.toast.checkFailed': 'Не вдалося перевірити оновлення через OpenCode',
  ...
  "settings.providers.page.custom.models.variantsLabel": "Рівні міркування",
  "settings.providers.page.custom.models.variantsPlaceholder": "low, medium, high",
  "settings.providers.page.custom.models.variantsInfo": "Необов’язково. Рівні зусилля через кому, які приймає endpoint, наприклад low, medium, high. Кожен стає варіантом, який можна вибрати в перемикачі моделей.",
  ...
  "settings.openchamber.visual.goal.charLimitLabel": "Ліміт символів мети",
  "settings.openchamber.visual.goal.charLimitAria": "Максимальна кількість символів для опису мети",
  "settings.openchamber.visual.goal.maxTurnsLabel": "Обмежити кількість автопродовжень",
  "settings.openchamber.visual.goal.maxTurnsAria": "Обмежує кількість автоматичних продовжень перед тим, як мету буде заблоковано; якщо не позначено — без обмежень",
  ...
  'settings.commands.page.field.subagent': 'Запускати в дочірній сесії',
  ...
  'settings.mcp.page.advanced.timeoutCatalogHint': 'Скільки чекати, поки сервер перелічить свої інструменти.',
  'settings.mcp.page.advanced.timeoutExecutionMs': 'Тайм-аут виконання (мс)',
  'settings.mcp.page.advanced.timeoutExecutionHint': 'Скільки чекати на завершення одного виклику інструмента.',
  "settings.mcp.page.advanced.summary.startup": "запуск {value}",
  "settings.mcp.page.advanced.summary.catalog": "каталог {value}",
  "settings.mcp.page.advanced.summary.execution": "виконання {value}",
  "settings.mcp.page.advanced.codemodeDefaultHint": "За замовчуванням вирішує OpenCode: Code Mode увімкнений для більшості серверів, але OpenCode вимикає його для серверів із власним Code Mode, як-от executor.sh, а в PostHog просить звичайні інструменти замість його власного Code Mode.",
  "settings.mcp.page.advanced.codemodeOption.default": "За замовчуванням (вирішує OpenCode)",
  "settings.mcp.page.advanced.codemodeOption.on": "Увімкнено",
  "settings.mcp.page.advanced.codemodeOption.off": "Вимкнено",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode увімкнено",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode вимкнено",
  'settings.mcp.page.advanced.protocol': 'Протокол',
  'settings.mcp.page.advanced.protocolHint': 'Legacy відкриває з’єднання рукостисканням initialize і працює з ревізіями протоколу до 2025-11-25. Auto перевіряє ревізію 2026-07-28 і повертається до legacy, якщо сервер її не підтримує. 2026-07-28 вимагає цю ревізію й інакше завершується помилкою.',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy (за замовчуванням)',
  'settings.mcp.page.advanced.protocolOption.auto': 'Автоматично',
  'settings.mcp.page.advanced.protocolOption.revision20260728': '2026-07-28',
  'settings.mcp.page.advanced.oauth': 'OAuth',
  'settings.mcp.page.advanced.oauthMetadataUrl': 'URL метаданих сервера авторизації',
