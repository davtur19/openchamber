...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.showQuoteSource': '원본 메시지에서 보기',
  ...
  "diffView.fileTree.showAsList": "목록 보기",
  "diffView.fileTree.showAsTree": "트리 보기",
  "diffView.fileTree.collapseDirectoryAria": "{path} 접기",
  "diffView.fileTree.expandDirectoryAria": "{path} 펼치기",
  "diffView.fileTree.resize": "파일 트리 크기 조정",
  ...
  'chat.sessionError.noDetails': 'OpenCode가 세부 정보를 보고하지 않았습니다. 상태 보고서에서 최근 오류를 확인할 수 있습니다.',
  ...
  'aboutDialog.appVersionLabel': '앱 버전 {version}',
  ...
  'chat.textSelection.comment.save': '댓글 저장',
  ...
  "projectConfigError.toast.title": "OpenCode가 이 프로젝트의 설정을 불러올 수 없습니다",
  "projectConfigError.toast.unknownFile": "프로젝트 설정",
  "projectConfigError.toast.hint": "파일을 수정한 뒤 다시 시도하세요. 다른 프로젝트는 계속 사용할 수 있습니다.",
  "projectConfigError.toast.retry": "다시 시도",
  "projectConfigError.toast.retrying": "다시 시도하는 중…",
  ...
  'startup.initRecovery.serverUnreachable': 'OpenChamber가 서버에 연결할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  'startup.initRecovery.loadAgentsFailed': '서버는 실행 중이지만 OpenCode가 에이전트를 불러오지 못했습니다. 원인을 해결한 뒤 다시 시도하세요.',
  'startup.initRecovery.unexpected': 'OpenChamber 시작을 완료할 수 없습니다. 원인을 해결한 뒤 다시 시도하세요.',
