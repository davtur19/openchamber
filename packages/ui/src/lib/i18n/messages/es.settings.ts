...
export const settingsDict = {
  ...
  'settings.themeImport.catalogTitle': 'Importar tema de VS Code (Open VSX)',
  'settings.themeImport.catalogHint': 'Busca temas de VS Code en Open VSX. Los temas publicados solo en Microsoft Marketplace pueden no aparecer aquí.',
  'settings.themeImport.search': 'Buscar temas',
  'settings.themeImport.catalogError': 'No se pudieron cargar los temas de Open VSX. Vuelve a buscar.',
  'settings.themeImport.empty': 'No se encontraron temas en Open VSX.',
  'settings.themeImport.back': 'Volver a la búsqueda',
  'settings.themeImport.chooseFile': 'Elegir archivo JSON',
  'settings.themeImport.importSelected': 'Importar variantes seleccionadas',
  'settings.themeImport.installed': 'Importado',
  'settings.themeImport.partialError': 'No se pudieron guardar algunos temas. Se conservaron los importados correctamente. Puedes reintentar las variantes restantes.',
  'settings.themeImport.delete': 'Eliminar el tema importado {name}',
  'settings.themeImport.deleteError': 'No se pudo eliminar el tema. Se ha conservado.',
  'settings.themeImport.action': 'Importar tema de VS Code',
  'settings.themeImport.busy': 'Importando tema…',
  'settings.themeImport.hint': 'Importa un tema de VS Code .json o .jsonc con los colores de sintaxis y diff. Se guarda en el servidor OpenChamber conectado.',
  'settings.themeImport.success': 'Se importó {name}.',
  'settings.themeImport.error.invalid': 'Este archivo no es un tema de colores de VS Code compatible.',
  'settings.themeImport.error.include': 'El tema hace referencia a otro archivo. Expórtalo desde VS Code con Developer: Generate Color Theme From Current Settings e importa el JSON generado.',
  'settings.themeImport.error.size': 'Los archivos de temas no pueden superar los 512 KiB.',
  'settings.themeImport.error.background': 'Este tema no tiene el color editor.background. Exporta un tema de colores completo desde VS Code.',
  'settings.themeImport.error.save': 'No se pudo guardar el tema. Comprueba la conexión e inténtalo de nuevo.',
  'settings.themeImport.error.connection': 'El servidor conectado ha cambiado. No se aplicó el tema.',
  'settings.themeImport.error.unsupported': 'La importación de temas no está disponible en VS Code.',
  'settings.themeImport.error.conflict': 'Este tema importado se modificó en el servidor. No se sobrescribió.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.common.actions.close": "Cerrar",
  ...
  "settings.common.status.saveFailedReason": "No se pudo guardar: {reason}",
  ...
  "settings.openchamber.about.actions.updateOpenChamberToVersion": "Actualizar OpenChamber a {version}",
  "settings.openchamber.about.actions.updateServerToVersion": "Actualizar el servidor de OpenChamber a {version}",
  "settings.openchamber.about.actions.updateDesktopToVersion": "Actualizar OpenChamber de escritorio a {version}",
  "settings.openchamber.about.actions.updateOpenCodeToVersion": "Actualizar OpenCode a {version}",
  "settings.openchamber.about.actions.checkServerForUpdates": "Buscar actualizaciones del servidor",
  "settings.openchamber.about.serviceManagerUpdate": "OpenChamber {version} está disponible. Este servidor se ejecuta bajo un gestor de servicios y no puede actualizarse solo. Ejecuta esto en el servidor y luego reinicia el servicio:",
  "settings.openchamber.about.openCode.installedVersion": "OpenCode {version} instalado. Recarga OpenCode para empezar a usarlo.",
  "settings.openchamber.about.openCode.installed": "Actualización de OpenCode instalada. Recarga OpenCode para empezar a usarla.",
  "settings.openchamber.about.openCode.manualUpdate": "OpenCode {version} está disponible. Actualiza OpenCode de la misma forma en que lo instalaste y luego reinicia OpenChamber.",
  "settings.openchamber.about.native.serverOpenChamberVersion": "Servidor: OpenChamber {version}",
  "settings.openchamber.about.native.serverOpenCodeVersion": "Servidor: OpenCode {version}",
  "settings.openchamber.about.native.appVersion": "Esta app: {version}",
  "settings.openchamber.about.toast.serverLatestVersion": "El servidor usa la última versión de OpenChamber",
  ...
  "settings.agents.page.permissionsEditor.mcpTitle": "Servidores MCP",
  "settings.agents.page.permissionsEditor.mcpInfo": "Una fila por cada servidor MCP de tu configuración. La regla cubre todas las herramientas del servidor. Los servidores desactivados o con fallos también aparecen, así puedes fijar una regla de antemano.",
  "settings.agents.page.permissionsEditor.mcpStatus.disabled": "Desactivado",
  "settings.agents.page.permissionsEditor.mcpStatus.pending": "Iniciando",
  ...
  "settings.agents.page.runtimeProvided.note": "Proporcionado por OpenCode o un plugin, sin archivo de configuración propio. Las pistas en gris muestran sus valores actuales; lo que escribas se guarda como una anulación.",
  ...
  "settings.behavior.page.toast.agentsMdChangedOnDisk": "AGENTS.md se modificó fuera de OpenChamber, así que tu cambio no se guardó. Cópialo y vuelve a abrir esta página para cargar el archivo actual.",
  ...
  "settings.openchamber.opencodeCli.restart.manualRequired": "Guardado en disco. Reinicia el servidor OpenCode conectado para aplicar los cambios.",
  "settings.openchamber.opencodeCli.restart.failed": "No se pudieron aplicar los cambios de configuración.",
  "settings.openchamber.opencodeCli.actions.restart": "Reiniciar OpenCode",
  "settings.openchamber.opencodeCli.restart.external": "Este OpenCode se inició fuera de OpenChamber. Reinícialo donde lo iniciaste.",
  "settings.openchamber.opencodeCli.restart.restartFailed": "No se pudo reiniciar OpenCode.",
  ...
  'settings.plugins.sidebar.kind.package': 'Paquete de plugin',
  ...
  'settings.plugins.status.loadedVersion': 'Cargado · {version}',
  'settings.plugins.status.failed.title': 'Error al cargar',
  'settings.plugins.status.failed.ref': 'Referencia de registro: {ref}',
  'settings.plugins.status.notReported.title': 'No cargado',
  'settings.plugins.status.notReported.description': 'OpenCode no ha informado de este plugin aquí. Puede que aún se esté instalando o que otra entrada de configuración lo desactive.',
  'settings.plugins.status.unknown.title': 'Estado desconocido',
  'settings.plugins.status.unknown.description': 'No se pudo leer el estado del plugin desde OpenCode.',
  'settings.plugins.status.retry': 'Reintentar',
  'settings.plugins.status.sidebar.unavailable': 'Estado de plugins no disponible',
  'settings.plugins.update.available.title': 'Actualización disponible',
  'settings.plugins.update.available.description': 'Hay una versión más reciente que coincide con esta especificación. Al actualizar se reinstala sin cambiar tu configuración.',
  'settings.plugins.update.action': 'Actualizar',
  'settings.plugins.update.running': 'Actualizando…',
  'settings.plugins.update.failed.title': 'Error al actualizar',
  'settings.plugins.update.toast.done': '{name} actualizado',
  'settings.plugins.update.toast.failed': 'No se pudo actualizar {name}',
  'settings.plugins.toast.checkFailed': 'No se pudieron buscar actualizaciones mediante OpenCode',
  ...
  "settings.providers.page.custom.models.variantsLabel": "Niveles de razonamiento",
  "settings.providers.page.custom.models.variantsPlaceholder": "low, medium, high",
  "settings.providers.page.custom.models.variantsInfo": "Opcional. Niveles de esfuerzo separados por comas que acepta el endpoint, p. ej. low, medium, high. Cada uno se convierte en una variante que puedes elegir en el selector de modelos.",
  ...
  "settings.mcp.page.advanced.title": "Avanzado",
  ...
  "settings.openchamber.visual.field.animatedActivityIndicators": "Indicadores de actividad animados",
  "settings.openchamber.visual.field.animatedActivityIndicatorsAria": "Mostrar un indicador animado en las sesiones en ejecución",
  "settings.openchamber.visual.field.animatedActivityIndicatorsInfo": "Las sesiones en ejecución muestran un indicador animado en lugar del punto estático. El indicador se actualiza 20 veces por segundo y consume más energía que el punto. Esta animación se reproduce incluso cuando se habilita Reducir movimiento.",
  ...
  "settings.openchamber.visual.goal.charLimitLabel": "Límite de caracteres del objetivo",
  "settings.openchamber.visual.goal.charLimitAria": "Número máximo de caracteres permitido para el objetivo de una meta",
  "settings.openchamber.visual.goal.maxTurnsLabel": "Limitar los turnos de continuación automática",
  "settings.openchamber.visual.goal.maxTurnsAria": "Limita el número de continuaciones automáticas antes de que una meta se marque como bloqueada; desmarcado significa ilimitado",
  ...
  "settings.openchamber.visual.field.enterToSend": "Atajo de envío",
  "settings.openchamber.visual.field.enterToSendHint": "Elige el atajo de envío para el compositor estándar. En el compositor expandido, Intro siempre añade una nueva línea y Ctrl/Cmd+Intro envía.",
  ...
  'settings.commands.page.field.subagent': 'Ejecutar en una sesión hija',
  'settings.commands.page.field.subagentTooltip': 'El comando se ejecuta en una sesión hija en segundo plano en vez de en la actual.',
  'settings.common.legacyFormat.note': 'Este archivo todavía usa el formato de OpenCode 1. El próximo guardado lo reescribirá como OpenCode 2.',
  'settings.mcp.page.advanced.codemode': 'Code Mode',
  'settings.mcp.page.advanced.codemodeHint': 'Normalmente cada herramienta de un servidor MCP se convierte en una herramienta aparte que el modelo ve y llama de una en una. Con Code Mode el modelo recibe una sola herramienta que ejecuta un script corto, y ese script llama a las herramientas de este servidor como funciones. Así el contexto no crece cuando un servidor tiene muchas herramientas y varias llamadas caben en un solo paso. Los modelos más pequeños escriben esos scripts con menos fiabilidad, por eso se puede desactivar por servidor.',
  'settings.mcp.page.advanced.timeoutStartupMs': 'Tiempo de arranque (ms)',
  'settings.mcp.page.advanced.timeoutStartupHint': 'Cuánto esperar a que arranque el proceso del servidor.',
  'settings.mcp.page.advanced.timeoutCatalogMs': 'Tiempo de catálogo (ms)',
  'settings.mcp.page.advanced.timeoutCatalogHint': 'Cuánto esperar mientras el servidor lista sus herramientas.',
  'settings.mcp.page.advanced.timeoutExecutionMs': 'Tiempo de ejecución (ms)',
  'settings.mcp.page.advanced.timeoutExecutionHint': 'Cuánto esperar a que termine una llamada de herramienta.',
  "settings.mcp.page.advanced.summary.startup": "arranque {value}",
  "settings.mcp.page.advanced.summary.catalog": "catálogo {value}",
  "settings.mcp.page.advanced.summary.execution": "ejecución {value}",
  "settings.mcp.page.advanced.codemodeDefaultHint": "Predeterminado deja que OpenCode decida: Code Mode está activado en la mayoría de los servidores, pero OpenCode lo desactiva en los que traen el suyo propio, como executor.sh, y pide a PostHog herramientas simples en lugar de su propio Code Mode.",
  "settings.mcp.page.advanced.codemodeOption.default": "Predeterminado (decide OpenCode)",
  "settings.mcp.page.advanced.codemodeOption.on": "Activado",
  "settings.mcp.page.advanced.codemodeOption.off": "Desactivado",
  "settings.mcp.page.advanced.summary.codemodeOn": "Code Mode activado",
  "settings.mcp.page.advanced.summary.codemodeOff": "Code Mode desactivado",
  'settings.mcp.page.advanced.protocol': 'Protocolo',
  'settings.mcp.page.advanced.protocolHint': 'Legacy abre la conexión con el handshake initialize y habla revisiones del protocolo hasta 2025-11-25. Auto sondea la revisión 2026-07-28 y vuelve a legacy cuando el servidor no la admite. 2026-07-28 exige esa revisión y falla en caso contrario.',
  'settings.mcp.page.advanced.protocolOption.legacy': 'Legacy (predeterminado)',
  'settings.mcp.page.advanced.protocolOption.auto': 'Automático',
  'settings.mcp.page.advanced.protocolOption.revision20260728': '2026-07-28',
  'settings.mcp.page.advanced.oauth': 'OAuth',
  'settings.mcp.page.advanced.oauthMetadataUrl': 'URL de metadatos del servidor de autorización',
