...
export const dict: Record<I18nKey, string> = {
  ...
  "opencodeCompatibility.install": "Atualizar para OpenCode v2",
  "opencodeCompatibility.reconnect": "Verificar novamente",
  "opencodeCompatibility.guide": "Guia de instalação",
  "opencodeCompatibility.installing": "Instalando OpenCode v2…",
  "opencodeCompatibility.reconnecting": "Reconectando…",
  "opencodeCompatibility.failed": "Não foi possível concluir a operação. Tente novamente ou siga o guia de instalação e reconecte-se.",
  ...
  'smallModel.toast.unavailable.title': 'Small Model indisponível',
  'smallModel.toast.unavailable.description': 'Escolha outro modelo em Configurações → Sessões → Small Model e tente novamente.',
  ...
  'chat.message.context.showQuoteSource': 'Mostrar na mensagem original',
  ...
  "mobile.header.openWorkspaceWithChangesAria": "Abrir painel do workspace, alterações não confirmadas",
  "mobile.header.openMetadataAria": "Abrir metadados da sessão",
  "mobile.header.metadata.context": "Contexto",
  "mobile.header.metadata.contextPending": "O uso do contexto aparece assim que a sessão começar.",
  ...
  "sessions.sidebar.header.actions.sortWorktrees": "Ordenar worktrees",
  "sessions.sidebar.header.worktreeSort.recent": "Atividade recente",
  ...
  "sessions.sidebar.header.viewMode.projects": "Agrupado",
  "sessions.sidebar.header.viewMode.timeline": "Linha do tempo",
  ...
  'sessions.sidebar.session.moveToWorktree.outcomeUnknown': 'O novo worktree foi mantido: a movimentação ainda pode ser concluída no servidor.',
  ...
  "sessions.sidebar.session.moveToWorktree.tooltip": 'Cria um novo worktree a partir da branch atual e move esta sessão e suas subsessões para lá. Alterações não confirmadas permanecem no worktree de origem.',
  ...
  "sessions.sidebar.session.rename.error": "Não foi possível renomear a sessão. {detail}",
  "sessions.sidebar.session.action.upstreamErrorWithRef": "O OpenCode respondeu {status} {name} (ref {ref}). Procure essa ref no log do OpenCode.",
  "sessions.sidebar.session.action.upstreamError": "O OpenCode respondeu {status}: {message}",
  "sessions.sidebar.session.action.noDetails": "sem detalhes",
  ...
  "contextRail.editor.toggle": "Alternar editor de arquivos",
  ...
  "sidebarFilesTree.menu.uploadFiles": "Enviar arquivos",
  ...
  "sidebarFilesTree.actions.uploadFilesTitle": "Enviar arquivos",
  ...
  "contextUsage.compacted.description": "Contexto compactado. O uso será atualizado após a próxima resposta.",
  ...
  "diffView.fileTree.showAsList": "Visualização em lista",
  "diffView.fileTree.showAsTree": "Visualização em árvore",
  "diffView.fileTree.collapseDirectoryAria": "Recolher {path}",
  "diffView.fileTree.expandDirectoryAria": "Expandir {path}",
  "diffView.fileTree.resize": "Redimensionar árvore de arquivos",
  ...
  "diffView.unavailable.missingTitle": "O arquivo não existe mais",
  ...
  "diffView.submodule.added": "Novo submódulo no commit {commit}",
  "diffView.submodule.removed": "Submódulo removido, estava no commit {commit}",
  "diffView.submodule.notCheckedOut": "Não foi feito checkout. Commit registrado: {commit}",
  "diffView.submodule.trackedChanges": "Tem alterações não commitadas",
  "diffView.submodule.untrackedFiles": "Tem arquivos não rastreados",
  "diffView.submodule.conflict": "Conflito de merge no commit registrado",
  ...
  "chat.goal.button.noSmallModel": "Metas precisam de um Small Model. Entre em um provedor de modelos ou escolha um em Configurações → Sessões.",
  "chat.goal.dialog.noSmallModel": "Metas precisam de um Small Model para verificar o progresso. Entre em um provedor de modelos ou escolha um em Configurações → Sessões.",
  ...
  "aboutDialog.appVersionLabel": "Versão do app {version}",
  ...
  'chat.commandAutocomplete.command.forkDescription': 'Bifurque este chat a partir da última resposta concluída e continue lá; o texto após /fork é enviado para a bifurcação.',
  ...
  "chat.textSelection.comment.save": "Salvar comentário",
  ...
  "chat.messageBody.actions.branchMenu": "Continuar a partir desta resposta",
  ...
  'chat.chatInput.toast.forkFailed': 'Não foi possível bifurcar a sessão',
  'chat.chatInput.toast.forkNothingToFork': 'Ainda não há o que bifurcar: nenhuma resposta foi concluída nesta sessão',
  'chat.chatInput.toast.forkSendFailed': 'Bifurcada, mas a mensagem não foi enviada. Ela voltou para o editor.',
  ...
  "chat.toolPart.questionsAsked": 'Perguntas feitas: {count}',
  "chat.toolPart.filesCount": 'Arquivos: {count}',
  "chat.toolPart.moreToolCalls": '+{count} mais',
  "chat.toolPart.scriptCalls": 'Chamadas de ferramentas',
  "chat.toolPart.outputTruncated": 'A saída foi truncada',
  ...
  'chat.toolPart.blocked': 'Bloqueado',
  ...
  "onboarding.localSetup.description": "Instale a CLI do OpenCode v2 para continuar.",
  ...
  "onboarding.localSetup.intro": "Instale a CLI do OpenCode v2 para continuar.",
  "onboarding.localSetup.docs.windows": "Guia de instalação",
  "onboarding.localSetup.docs.default": "Guia de instalação",
  ...
  "onboarding.localSetup.status.watching": "Aguardando OpenCode v2",
  ...
  "projectConfigError.toast.title": "O OpenCode não consegue carregar a configuração deste projeto",
  "projectConfigError.toast.unknownFile": "Configuração do projeto",
  "projectConfigError.toast.hint": "Corrija o arquivo e tente novamente. Os outros projetos continuam funcionando.",
  "projectConfigError.toast.retry": "Tentar novamente",
  "projectConfigError.toast.retrying": "Tentando novamente…",
  ...
  "startup.initRecovery.serverUnreachable": "O OpenChamber não conseguiu acessar o servidor. Verifique se o servidor está em execução e tente novamente.",
  "startup.initRecovery.loadAgentsFailed": "O servidor está em execução, mas o OpenCode não conseguiu carregar os agentes. Tente novamente depois de corrigir a causa.",
  "startup.initRecovery.unexpected": "O OpenChamber não conseguiu concluir a inicialização. Tente novamente depois de corrigir a causa.",
  ...
  "opencodeUpdate.toast.available.manualDescription": 'Versão {version} disponível. Atualize o OpenCode da mesma forma que o instalou e depois reinicie o OpenChamber.',
  ...
  'chat.workStatus.sections.reorder': 'Arraste {label} para reordenar',
  'chat.workStatus.sections.dragInstructions': 'Pressione Espaço para selecionar uma seção, use as setas para movê-la e pressione Espaço para soltar. Pressione Escape para cancelar.',
  'chat.workStatus.sections.position': '{label}, posição {position} de {count}.',
  'chat.workStatus.sections.dragCancelled': 'Reordenação cancelada.',
  ...
  'chat.formCard.inputNeeded': 'Resposta necessária',
  'chat.formCard.fromSubagent': 'de um subagente',
  'chat.formCard.required': 'Obrigatório',
  'chat.formCard.openLink': 'Abrir link',
  'chat.formCard.yes': 'Sim',
  'chat.formCard.other': 'Outro',
  'chat.formCard.yourAnswer': 'Sua resposta',
  'chat.formCard.submit': 'Enviar',
  'chat.formCard.cancel': 'Cancelar',
  'chat.formCard.missingRequired': 'Preencha primeiro os campos obrigatórios.',
  'chat.formCard.submitFailed': 'Não foi possível enviar a resposta',
  'chat.formCard.cancelFailed': 'Não foi possível cancelar a solicitação',
  'chat.formCard.tryAgain': 'Tente novamente.',
  'chat.formDock.progress': '{current} de {total}',
  'chat.formDock.waiting': 'mais {count} aguardando',
  'chat.formDock.back': 'Voltar',
  'chat.formDock.expandAria': 'Expandir a pergunta',
  'chat.formDock.collapseAria': 'Recolher a pergunta',
  'chat.formDock.stepAria': 'Pergunta {index}: {title}',
  'chat.formDock.linkInfo': 'Abra o link e depois continue.',
  'chat.permissionCard.title': 'Permissão necessária',
  'chat.permissionCard.summary.externalDirectory': "Acessar arquivos fora do projeto",
  'chat.permissionCard.summary.read': "Ler um arquivo",
  'chat.permissionCard.summary.edit': "Editar arquivos",
  'chat.permissionCard.summary.shell': "Executar um comando",
  'chat.permissionCard.summary.glob': "Encontrar arquivos",
  'chat.permissionCard.summary.grep': "Pesquisar no conteúdo dos arquivos",
  'chat.permissionCard.summary.webfetch': "Abrir uma página da web",
  'chat.permissionCard.summary.websearch': "Pesquisar na web",
  'chat.permissionCard.summary.skill': "Carregar uma skill",
  'chat.permissionCard.summary.tool': "Usar {tool}",
  'chat.permissionCard.summary.inPath': "em {path}",
  'chat.permissionCard.showDetails': "Mostrar detalhes",
  'chat.permissionDock.expandAria': 'Expandir a solicitação de permissão',
  'chat.permissionDock.collapseAria': 'Recolher a solicitação de permissão',
  'chat.permissionDock.stepAria': 'Solicitação {index}: {tool}',
  'chat.permissionCard.allowOnce': 'Permitir uma vez',
  'chat.permissionCard.alwaysAllow': 'Permitir sempre',
  'chat.permissionCard.alwaysAllowPatterns': 'Sempre: {patterns}',
  'chat.permissionCard.deny': 'Negar',
  'chat.permissionCard.replaceAll': 'Substitui todas as ocorrências',
  'chat.compaction.running': 'Compactando a conversa',
  'chat.compaction.completed': 'Conversa compactada',
